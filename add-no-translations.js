...
const serviceTranslations = {
  ...
  burmese: 'သင့်စက်တွင် ဒီမီဒီယာဖိုင်ကို ဖွင့်၍ မရပါ။',
  cymrufyw: '',
  ...
  news: 'په دې وسیله کې د غږ اوريدل او ویډیو لیدنه شونې نه ده.',
  pashto: 'پخش این فایل در دستگاه شما پشتیبانی نمی شود.',
  persian: 'Dem no support media player for your device',
  pidgin:
    'A reprodução deste formato de vídeo não é compatível com seu dispositivo',
  portuguese: "ਮੀਡੀਆ ਪਲੇਬੈਕ ਤੁਹਾਡੀ ਡਿਵਾਈਸ 'ਤੇ ਸਪੋਰਟ ਨਹੀਂ ਕਰਦਾ",
  punjabi: '',
  russian: '',
