...
Simorgh is a universal react renderer. It uses [Razzle](https://github.com/jaredpalmer/razzle) and is built on [react-universal-app](https://github.com/jtart/react-universal-app/blob/master/README.md). This repo is publicly accessible and the application will be used to generate the future, pan-BBC article.
