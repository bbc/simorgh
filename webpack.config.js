...
module.exports = (shell = {}) => {
  ...
  if (CONFIG_FILE === 'client') {
    return [CLIENT_LEGACY, CLIENT_MODERN, CLIENT_LOW].map(mergeIntoBaseConfig);
  }
  ...
  return [CLIENT_LEGACY, CLIENT_MODERN, CLIENT_LOW, SERVER].map(mergeIntoBaseConfig);
};
