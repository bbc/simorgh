...
const REITH_SERIF_REGULAR = {
  '@font-face': {
    ...
    src: "url('https://static.files.bbci.co.uk/fonts/reith/2.512/BBCReithSerif_W_Rg.woff2') format('woff2'), url('https://static.files.bbci.co.uk/fonts/reith/2.512/BBCReithSerif_W_Rg.woff') format('woff')",
    fontDisplay: 'block',
  },
};
...
const REITH_SERIF_BOLD = {
  '@font-face': {
    fontFamily: 'ReithSerif',
    src: "url('https://static.files.bbci.co.uk/fonts/reith/2.512/BBCReithSerif_W_Bd.woff2') format('woff2'), url('https://static.files.bbci.co.uk/fonts/reith/2.512/BBCReithSerif_W_Bd.woff') format('woff')",
    fontWeight: 700,
    fontDisplay: 'block',
  },
};
...
const REITH_SERIF_LIGHT = {
  '@font-face': {
    fontFamily: 'ReithSerif',
    src: "url('https://static.files.bbci.co.uk/fonts/reith/2.512/BBCReithSerif_WNumbers_Lt.woff2') format('woff2'), url('https://static.files.bbci.co.uk/fonts/reith/2.512/BBCReithSerif_WNumbers_Lt.woff') format('woff')",
    fontWeight: 300,
    fontDisplay: 'block',
  },
};
...
const REITH_SERIF_MEDIUM = {
  '@font-face': {
    fontFamily: 'ReithSerif',
    src: "url('https://static.files.bbci.co.uk/fonts/reith/2.512/BBCReithSerif_W_Md.woff2') format('woff2'), url('https://static.files.bbci.co.uk/fonts/reith/2.512/BBCReithSerif_W_Md.woff') format('woff')",
    fontWeight: 500,
    fontDisplay: 'block',
  },
};
...
const REITH_SERIF_EXTRA_BOLD = {
  '@font-face': {
    fontFamily: 'ReithSerif',
    src: "url('https://static.files.bbci.co.uk/fonts/reith/2.512/BBCReithSerif_W_ExBd.woff2') format('woff2'), https://static.files.bbci.co.uk/fonts/reith/2.512/BBCReithSerif_W_ExBd.woff') format('woff')",
    fontWeight: 800,
    fontDisplay: 'block',
  },
};
...
const REITH_SANS_CONDENSED_REGULAR = {
  '@font-face': {
    ...
    src: 'url("https://static.files.bbci.co.uk/fonts/reith/2.512/BBCReithSansCd_W_Rg.woff2") format("woff2"), url("https://static.files.bbci.co.uk/fonts/reith/2.512/BBCReithSansCd_W_Rg.woff") format("woff")',
    fontDisplay: 'block',
  },
};
...
const REITH_SANS_CONDENSED_BOLD = {
  '@font-face': {
    fontFamily: 'ReithSansCondensed',
    fontWeight: 700,
    src: 'url("https://static.files.bbci.co.uk/fonts/reith/2.512/BBCReithSansCd_W_Bd.woff2") format("woff2"), url("https://static.files.bbci.co.uk/fonts/reith/2.512/BBCReithSansCd_W_Bd.woff") format("woff")',
    fontDisplay: 'block',
  },
};
