...
Object.keys(services)
  ...
  describe(`${service} Article Meta Tests`, () => {
    ...
    before(() => {
      cy.visit(`/${service}/articles/${services[service].pageTypes.articles.asset}`);
    });

    it('should have the correct lang & dir attributes', () => {
      hasHtmlLangDirAttributes({ lang: `${testData[service].datetimeLocale}`, dir: `${testData[service].dir}`});
    });
