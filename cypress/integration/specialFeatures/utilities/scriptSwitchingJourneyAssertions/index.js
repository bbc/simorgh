...
export const assertScriptSwitchButton = (product, variantValue) => {
...
export const assertURLContains = (product, variantValue) => {
  cy.url().should(url => {
    url.includes(`${product}/${variantValue}/`);
  });
};

export const assertLang = (serviceName, variantValue) => {
