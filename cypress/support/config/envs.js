const config = {
  ...
  local: {
    baseUrl: 'http://alistair-simorgh-test.herokuapp.com:7080',
    dataUrl: 'http://alistair-simorgh-test.herokuapp.com:7080',
    assetUrl: 'http://alistair-simorgh-test.herokuapp.com:7080',
    assetOrigin: 'http://alistair-simorgh-test.herokuapp.com:7080',
    atiUrl: 'https://logws1363.ati-host.net?',
    chartbeatEnabled: false,
    avEmbedBaseUrl: 'https://polling.test.bbc.co.uk',
