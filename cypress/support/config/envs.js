const config = {
  ...
  local: {
    baseUrl: 'http://host.docker.internal:7080',
    dataUrl: 'http://host.docker.internal:7080',
    assetUrl: 'http://host.docker.internal:7080',
    assetOrigin: 'http://host.docker.internal:7080',
    atiUrl: 'https://logws1363.ati-host.net?',
    chartbeatEnabled: true,
    avEmbedBaseUrl: 'https://polling.test.bbc.co.uk',
