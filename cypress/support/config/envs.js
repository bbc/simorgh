const config = {
  ...
  local: {
    baseUrl: 'http://simorgh_simorgh-local:7080',
    dataUrl: 'http://simorgh_simorgh-local:7080',
    assetUrl: 'http://simorgh_simorgh-local:7080',
    assetOrigin: 'http://simorgh_simorgh-local:7080',
    atiUrl: 'https://logws1363.ati-host.net?',
    chartbeatEnabled: true,
    avEmbedBaseUrl: 'https://polling.test.bbc.co.uk',
