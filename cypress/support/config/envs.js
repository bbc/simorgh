const config = {
  ...
  local: {
    baseUrl: 'http://alistair-simorgh-test.herokuapp.com',
    dataUrl: 'http://alistair-simorgh-test.herokuapp.com',
    assetUrl: 'http://alistair-simorgh-test.herokuapp.com',
    assetOrigin: 'http://alistair-simorgh-test.herokuapp.com',
    atiUrl: 'https://logws1363.ati-host.net?',
    chartbeatEnabled: false,
    avEmbedBaseUrl: 'https://polling.test.bbc.co.uk',
