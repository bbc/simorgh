...
const allServices = appEnv => ({
  ...
  serbianCyr: {
    ...
    pageTypes: {
      ...
      frontPage: {
        path: isLive(appEnv) || isTest(appEnv) ? undefined : '/serbian/cyr',
        smoke: true,
      },
      liveRadio: { path: undefined, smoke: false },
      mediaAssetPage: {
        path: isLive(appEnv) || isTest(appEnv) ? undefined : undefined, // '/serbian/srbija-49427344/cyr'
        smoke: false,
      },
    },
  },
  ...
  ukchinaTrad: {
    ...
    pageTypes: {
      ...
      frontPage: {
        path: isLive(appEnv) || isTest(appEnv) ? undefined : '/ukchina/trad',
        smoke: true,
      },
      liveRadio: { path: undefined, smoke: false },
      mediaAssetPage: {
        path: isLive(appEnv) || isTest(appEnv) ? undefined : undefined, // '/ukchina/49375846/trad'
        smoke: false,
      },
    },
  },
  ...
  zhongwenTrad: {
    ...
    pageTypes: {
      ...
      frontPage: {
        path: isLive(appEnv) || isTest(appEnv) ? undefined : '/zhongwen/trad',
        smoke: true,
      },
      liveRadio: { path: undefined, smoke: false },
      mediaAssetPage: {
        path: isLive(appEnv) || isTest(appEnv) ? undefined : undefined, // '/zhongwen/chinese-news-49631219/trad'
        smoke: false,
      },
    },
  },
