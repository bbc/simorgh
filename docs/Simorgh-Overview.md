...
Now that the SPA is bootstrapped on the users device and onward journeys to further Simorgh pages are captured by react-router and rendered on entirely on the client.
