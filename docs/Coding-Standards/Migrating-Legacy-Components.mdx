...
*The `isRequired` option indicates whether a prop is mandatory or not.*
...
*Ensure that the `jsx` function is imported from the `@emotion/react` library, per the [https://emotion.sh/docs/css-prop#import-the-jsx-function-from-emotionreact](https://emotion.sh/docs/css-prop#import-the-jsx-function-from-emotionreact) docs.*
...
*It was possible to pass in props to conditonally change the css*
