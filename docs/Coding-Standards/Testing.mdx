...
If any unit snapshots remain, keep them small and review snapshot diffs carefully in PR.
...
Example where a snapshot is appropriate (small, stable JSON config output):
