...
- _The component requires modification as part of feature delivery_
...
- _The component is small and simple_
  ...
  The work involved in standardising these components is likely to be minimal, and so, makes them good candidates for migration.
...
- _The component is likely to be require modification in future development work_
