...
| 14       | Genre: Politics | Image (caption), Text (3 pars, 1 empty), Headline, Subheadline, Text (1 par), Text (1 par), Text (2 pars), Subheadline, Subheadline, Text (1 par, internal link) | 1 tag, 1 topic (event) | Will fail in v1.0 - consecutive Subheadlines|
...
| 16       | Category: Feature | Video, Text (2 pars), Headline, Subheadline, Image (wide), Text (1 par), Subheadline, Image, Text (3 pars, Subheadline, Image, Text (1 par), Subheadline, Image (caption), Text (2 pars) | None | Will fail in v1.0 - blocks before headline |
| 17       | Category: Analysis | Video, Image, Headline, Text (4 pars), Subheadline, Text (4 pars), Video, Text (1 par), Subheadline, Text (2 pars), Image (caption), Text (1 par), Subheadline, Text (2 pars), Video (caption), Text (1 par) | None | Will fail in v1.0 - blocks before headline |
| 18       | | Text (1 par), Subheadline, Headline, Image, Video, Image, Subheadline, Image | None | Will fail in v1.0 - Subheadline before headline |
| 19       | | Subheadline, Text (1 par), Headline, Video | None | Will fail in v1.0 - Subheadline before headline |
| 20       | | Headline, Image (caption) | None | |
| 21       | Genre: Business | Subheadline, Text (4 pars) | None | Will fail in v1.0 - no headline |
