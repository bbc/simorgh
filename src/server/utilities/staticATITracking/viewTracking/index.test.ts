...
<<<<<<<< HEAD:src/app/lib/analyticsUtils/staticATITracking/viewTracking/index.test.ts
  it('STATIC_ATI_VIEW_TRACKING variable is correct', () => {
========
  it('STATIC_ATI_VIEW_TRACKING tracking variable is correct', () => {
>>>>>>>> 6ab6f3db1add8163fb91a70de3378ac3fcd0a3c9:src/server/utilities/staticATITracking/viewTracking/index.test.ts
