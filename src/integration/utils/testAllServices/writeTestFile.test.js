...
describe('should generate test files from a given test example', () => {
  ...
  describe('AMP platform', () => {
    it('should create the directory for the generated AMP tests to go in', () => {
      ...
      expect(dirPath).toMatch(
        '/simorgh/src/integration/allServices/persian/liveRadio',
      );
    });
    ...
    it('should write the generated test file in the new directory', () => {
      ...
      expect(filePath).toMatch(
        `/simorgh/src/integration/allServices/persian/liveRadio/amp.test.js`,
      );
  ...
  describe('canonical platform', () => {
    ...
    it('should write the generated test file in the new directory', () => {
      ...
      expect(filePath).toMatch(
        `/simorgh/src/integration/allServices/persian/liveRadio/canonical.test.js`,
      );
...
describe('should generate test files from a given test example for services with variants', () => {
  ...
  describe('AMP platform', () => {
    it('should create the directory for the generated AMP tests to go in', () => {
      ...
      expect(dirPath).toMatch(
        '/simorgh/src/integration/allServices/zhongwen/simp/articles',
      );
    });
    ...
    it('should write the generated test file in the new directory', () => {
      ...
      expect(filePath).toMatch(
        `/simorgh/src/integration/allServices/zhongwen/simp/articles/amp.test.js`,
      );
  ...
  describe('canonical platform', () => {
    ...
    it('should write the generated test file in the new directory', () => {
      ...
      expect(filePath).toMatch(
        `/simorgh/src/integration/allServices/zhongwen/simp/articles/canonical.test.js`,
      );
