...
export default () => {
  const htmlString = getHtmlString(document);
  ...
  it('Full page HTML', () => {
    removeElements(doc.querySelectorAll('[data-styled], style[amp-custom]')); // styles change between each build for some reason
