...
it('I can see a page title - AMP', () => {
  ...
  expect(pageTitle).toMatchInlineSnapshot(
    `"Ўзбекистон, Коронавирус: Мирзиёев Хитой усулини қўлламоқчи - O\`zbekiston - BBC News O'zbek"`,
  );
});
...
it('I can see a headline - AMP', () => {
  ...
  expect(headline).toMatchInlineSnapshot(
    `"Ўзбекистон, Коронавирус: Мирзиёев Хитой усулини қўлламоқчи - O\`zbekiston"`,
  );
});
