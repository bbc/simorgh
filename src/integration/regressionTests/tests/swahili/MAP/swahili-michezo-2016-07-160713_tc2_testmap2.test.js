/**
 * @pathname /swahili/michezo/2016/07/160713_tc2_testmap2
 */
...
it('I can see a page title - AMP', () => {
  ...
  expect(pageTitle).toMatchInlineSnapshot(
    `"Matangazo ya Dira ya Dunia audio - BBC News Swahili"`,
  );
});
...
it('I can see a headline - AMP', () => {
  ...
  expect(headline).toMatchInlineSnapshot(`"Matangazo ya Dira ya Dunia audio"`);
});
