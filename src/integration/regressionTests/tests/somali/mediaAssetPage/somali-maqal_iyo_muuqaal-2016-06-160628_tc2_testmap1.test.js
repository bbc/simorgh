/**
 * @pathname /somali/maqal_iyo_muuqaal/2016/06/160628_tc2_testmap1
 */
...
it('I can see a page title - AMP', () => {
  ...
  expect(pageTitle).toMatchInlineSnapshot(
    `"Maxaa xiga ka bixista UK ee EU? - BBC News Somali"`,
  );
});
...
it('I can see a headline - AMP', () => {
  ...
  expect(headline).toMatchInlineSnapshot(`"Maxaa xiga ka bixista UK ee EU?"`);
});
