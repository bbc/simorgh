/**
 * @pathname /persian/magazine-49281981
 */
...
it('I can see a page title - AMP', () => {
  ...
  expect(pageTitle).toMatchInlineSnapshot(
    `"جشنواره بالون‌ها؛ دارت ویدر و پلنگ سیاه به پرواز در آمدند - BBC News فارسی"`,
  );
});
...
it('I can see a headline - AMP', () => {
  ...
  expect(headline).toMatchInlineSnapshot(
    `"جشنواره بالون‌ها؛ دارت ویدر و پلنگ سیاه به پرواز در آمدند"`,
  );
});
