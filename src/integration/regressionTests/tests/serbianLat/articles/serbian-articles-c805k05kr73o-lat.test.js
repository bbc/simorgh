/**
 * @pathname /serbian/articles/c805k05kr73o/lat
 */
...
it('I can see a page title - AMP', () => {
  ...
  expect(pageTitle).toMatchInlineSnapshot(
    `"Ratovi zvezda: Niški džedaji pomažu decu bez roditelja - BBC News na srpskom"`,
  );
});
...
it('I can see a headline - AMP', () => {
  ...
  expect(headline).toMatchInlineSnapshot(
    `"LAT - Ratovi zvezda: Niški džedaji pomažu decu bez roditelja"`,
  );
});
