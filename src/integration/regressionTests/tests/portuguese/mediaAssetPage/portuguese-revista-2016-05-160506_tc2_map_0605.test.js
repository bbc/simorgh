...
it('I can see a page title - AMP', () => {
  ...
  expect(pageTitle).toMatchInlineSnapshot(
    `"map 'Minha vida corre perigo': a troca de e-mails que desencadeou os Panama Papers - BBC News Brasil"`,
  );
});
...
it('I can see a headline - AMP', () => {
  ...
  expect(headline).toMatchInlineSnapshot(
    `"map 'Minha vida corre perigo': a troca de e-mails que desencadeou os Panama Papers"`,
  );
});
