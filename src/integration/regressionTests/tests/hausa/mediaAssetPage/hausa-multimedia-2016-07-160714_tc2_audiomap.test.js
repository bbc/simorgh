/**
 * @pathname /hausa/multimedia/2016/07/160714_tc2_audiomap
 */
...
it('I can see a page title - AMP', () => {
  ...
  expect(pageTitle).toMatchInlineSnapshot(
    `"Mawaka sun baje kolinsu da sallah a Kaduna - BBC News Hausa"`,
  );
});
...
it('I can see a headline - AMP', () => {
  ...
  expect(headline).toMatchInlineSnapshot(
    `"Mawaka sun baje kolinsu da sallah a Kaduna"`,
  );
});
