...
it('I can see a page title - AMP', () => {
  ...
  expect(pageTitle).toMatchInlineSnapshot(
    `"This is the full headline which appears inside the media asset page - BBC News Gahuza"`,
  );
});
...
it('I can see a headline - AMP', () => {
  ...
  expect(headline).toMatchInlineSnapshot(
    `"This is the full headline which appears inside the media asset page"`,
  );
});
