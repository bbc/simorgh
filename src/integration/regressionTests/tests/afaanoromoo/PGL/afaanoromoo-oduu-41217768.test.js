/**
 * @pathname /afaanoromoo/oduu-41217768
 */
...
it('I can see a page title - AMP', () => {
  ...
  expect(pageTitle).toMatchInlineSnapshot(
    `"Manneen durii 5 Magaalaa Finfinnee keessaa daawwachuu qabdan - BBC News Afaan Oromoo"`,
  );
});
...
it('I can see a headline - AMP', () => {
  ...
  expect(headline).toMatchInlineSnapshot(
    `"Manneen durii 5 Magaalaa Finfinnee keessaa daawwachuu qabdan"`,
  );
});
