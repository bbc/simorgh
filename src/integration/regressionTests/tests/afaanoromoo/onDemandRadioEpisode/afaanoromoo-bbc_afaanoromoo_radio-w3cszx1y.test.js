/**
 * @pathname /afaanoromoo/bbc_afaanoromoo_radio/w3cszx1y
 */
...
it('I can see a page title - AMP', () => {
  ...
  expect(pageTitle).toMatchInlineSnapshot(
    `"Oduu BBC Afaan Oromoo - BBC News Afaan Oromoo"`,
  );
});
...
it('I can see a headline - AMP', () => {
  ...
  expect(headline).toMatchInlineSnapshot(`"Oduu BBC Afaan Oromoo"`);
});
