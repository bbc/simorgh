...
it('I can see a page title - AMP', () => {
  ...
  expect(pageTitle).toMatchInlineSnapshot(
    `"২০২০ সালের ৩রা মার্চ, মঙ্গলবার কেন যুক্তরাষ্ট্রের রাজনীতিতে 'সুপার টিউসডে'? - BBC News বাংলা"`,
  );
});
...
it('I can see a headline - AMP', () => {
  ...
  expect(headline).toMatchInlineSnapshot(
    `"২০২০ সালের ৩রা মার্চ, মঙ্গলবার কেন যুক্তরাষ্ট্রের রাজনীতিতে 'সুপার টিউসডে'?"`,
  );
});
