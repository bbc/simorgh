/**
 * @pathname /kyrgyz/world-40847556
 */
...
it('I can see a page title - AMP', () => {
  ...
  expect(pageTitle).toMatchInlineSnapshot(
    `"Дүйнө тарыхын өзгөрткөн август - BBC News Кыргыз Кызматы"`,
  );
});
...
it('I can see a headline - AMP', () => {
  ...
  expect(headline).toMatchInlineSnapshot(`"Дүйнө тарыхын өзгөрткөн август"`);
});
