/**
 * @pathname /ukrainian/features-41278900
 */
...
it('I can see a page title - AMP', () => {
  ...
  expect(pageTitle).toMatchInlineSnapshot(
    `"Найкращий фотограф дикої природи-2017: фото фіналістів - BBC News Україна"`,
  );
});
...
it('I can see a headline - AMP', () => {
  ...
  expect(headline).toMatchInlineSnapshot(
    `"Найкращий фотограф дикої природи-2017: фото фіналістів"`,
  );
});
