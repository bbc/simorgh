/**
 * @pathname /ukrainian/other-news-23279018
 */
...
it('I can see a page title - AMP', () => {
  ...
  expect(pageTitle).toMatchInlineSnapshot(
    `"Коронавірус: як живе Україна на карантині (Ukrainian Test) - BBC News Україна"`,
  );
});
...
it('I can see a headline - AMP', () => {
  ...
  expect(headline).toMatchInlineSnapshot(
    `"Коронавірус: як живе Україна на карантині (Ukrainian Test)"`,
  );
});
