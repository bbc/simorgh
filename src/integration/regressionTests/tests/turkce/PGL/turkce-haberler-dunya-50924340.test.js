/**
 * @pathname /turkce/haberler-dunya-50924340
 */
...
it('I can see a page title - AMP', () => {
  ...
  expect(pageTitle).toMatchInlineSnapshot(
    `"2019'un en iyi okur fotoğrafları - BBC News Türkçe"`,
  );
});
...
it('I can see a headline - AMP', () => {
  ...
  expect(headline).toMatchInlineSnapshot(`"2019'un en iyi okur fotoğrafları"`);
});
