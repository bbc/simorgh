...
it('I can see a page title - AMP', () => {
  ...
  expect(pageTitle).toMatchInlineSnapshot(
    `"Bu test makalesi, web sitemizde otomatik uçtan uca testler yapabilmemiz - BBC News Türkçe"`,
  );
});
...
it('I can see a headline - AMP', () => {
  ...
  expect(headline).toMatchInlineSnapshot(`"Bu, test makalesinin başlığı"`);
});
