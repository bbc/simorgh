/**
 * @pathname /pashto/world/2016/09/160921_tc2_testmap1
 */
...
it('I can see a page title - AMP', () => {
  ...
  expect(pageTitle).toMatchInlineSnapshot(
    `"ازاده جرګه: د ملي وحدت حکومت لاسته راوړنې او نيمګړتياوې - BBC News پښتو"`,
  );
});
...
it('I can see a headline - AMP', () => {
  ...
  expect(headline).toMatchInlineSnapshot(
    `"ازاده جرګه: د ملي وحدت حکومت لاسته راوړنې او نيمګړتياوې"`,
  );
});
