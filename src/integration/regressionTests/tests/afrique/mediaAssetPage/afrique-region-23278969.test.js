/**
 * @pathname /afrique/region-23278969
 */
...
it('I can see a page title - AMP', () => {
  ...
  expect(pageTitle).toMatchInlineSnapshot(
    `"Afrique test video clip - They may be tiny, but us humans could learn a thing or two from ants. - BBC News Afrique"`,
  );
});
...
it('I can see a headline - AMP', () => {
  ...
  expect(headline).toMatchInlineSnapshot(
    `"Afrique test video clip - They may be tiny, but us humans could learn a thing or two from ants."`,
  );
});
