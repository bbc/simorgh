/**
 * @pathname /nepali/multimedia/2016/07/160725_tc2_testmap1
 */
...
it('I can see a page title - AMP', () => {
  ...
  expect(pageTitle).toMatchInlineSnapshot(
    `"बलिउड नृत्यद्वारा उपचार - BBC News नेपाली"`,
  );
});
...
it('I can see a headline - AMP', () => {
  ...
  expect(headline).toMatchInlineSnapshot(`"बलिउड नृत्यद्वारा उपचार"`);
});
