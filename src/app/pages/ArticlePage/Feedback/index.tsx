...
const Feedback = () => {
  return (
    <section css={styles.feedbackWrapper}>
      <div>
        <Heading level={2} size="pica" css={styles.feedbackHeading}>
      ...
      <div css={styles.feedbackButtons}>
        <a
          ...
          href="http://localhost:7081/mundo/send/u50853489?reaction=like&assetId=123456"
        >
          <Like />
        </a>
        <a
          css={styles.feedbackButton}
          href="http://localhost:7081/mundo/send/u50853489?reaction=dislike&assetId=123456"
        >
          <Dislike />
        </a>
      </div>
