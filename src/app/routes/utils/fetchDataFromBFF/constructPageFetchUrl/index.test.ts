...
describe('constructPageFetchUrl', () => {
  ...
  it.each`
    ...
    ${ARTICLE_PAGE} | ${null}         | ${null}    | ${'test'}   | ${'/ukrainian/articles/c0000000000o'} | ${'https://mock-bff-path/?id=c0000000000o&service=ukrainian&pageType=article'}
    ${ARTICLE_PAGE} | ${null}         | ${null}    | ${'live'}   | ${'/ukrainian/articles/c0000000000o'} | ${'https://mock-bff-path/?id=c0000000000o&service=ukrainian&pageType=article'}
    ${ARTICLE_PAGE} | ${null}         | ${'ru-UA'} | ${'local'}  | ${'/ukrainian/articles/c0000000000o'} | ${'http://localhost/ukrainian/articles/c0000000000o/ru-UA'}
    ${ARTICLE_PAGE} | ${null}         | ${'ru-UA'} | ${'test'}   | ${'/ukrainian/articles/c0000000000o'} | ${'https://mock-bff-path/?id=c0000000000o&service=ukrainian&pageType=article&variant=ru-UA'}
    ${ARTICLE_PAGE} | ${null}         | ${'ru-UA'} | ${'live'}   | ${'/ukrainian/articles/c0000000000o'} | ${'https://mock-bff-path/?id=c0000000000o&service=ukrainian&pageType=article&variant=ru-UA'}
    ...
    ${HOME_PAGE}    | ${null}         | ${null}    | ${'test'}   | ${'c0000000000t'}                     | ${'https://mock-bff-path/?id=cl13j7792ljt&service=ukrainian&pageType=home'}
    ${HOME_PAGE}    | ${null}         | ${null}    | ${'live'}   | ${'c0000000000t'}                     | ${'https://mock-bff-path/?id=c3eg5kglplrt&service=ukrainian&pageType=home'}
    ${LIVE_PAGE}    | ${null}         | ${null}    | ${'local'}  | ${'c0000000000t'}                     | ${'https://mock-bff-path/?id=c0000000000t&service=ukrainian&pageType=live'}
    ${LIVE_PAGE}    | ${null}         | ${null}    | ${'test'}   | ${'c0000000000t'}                     | ${'https://mock-bff-path/?id=c0000000000t&service=ukrainian&pageType=live'}
    ${LIVE_PAGE}    | ${null}         | ${null}    | ${'live'}   | ${'c0000000000t'}                     | ${'https://mock-bff-path/?id=c0000000000t&service=ukrainian&pageType=live'}
    ${TOPIC_PAGE}   | ${null}         | ${null}    | ${'local'}  | ${'/ukrainian/topics/c0000000000t'}   | ${'http://localhost/ukrainian/topics/c0000000000t'}
    ${TOPIC_PAGE}   | ${null}         | ${null}    | ${'test'}   | ${'/ukrainian/topics/c0000000000t'}   | ${'https://mock-bff-path/?id=c0000000000t&service=ukrainian&pageType=topic'}
    ${TOPIC_PAGE}   | ${null}         | ${null}    | ${'live'}   | ${'/ukrainian/topics/c0000000000t'}   | ${'https://mock-bff-path/?id=c0000000000t&service=ukrainian&pageType=topic'}
    ${TOPIC_PAGE}   | ${null}         | ${'ru-UA'} | ${'local'}  | ${'/ukrainian/topics/c0000000000t'}   | ${'http://localhost/ukrainian/ru-UA/topics/c0000000000t'}
    ${TOPIC_PAGE}   | ${null}         | ${'ru-UA'} | ${'test'}   | ${'/ukrainian/topics/c0000000000t'}   | ${'https://mock-bff-path/?id=c0000000000t&service=ukrainian&pageType=topic&variant=ru-UA'}
    ${TOPIC_PAGE}   | ${null}         | ${'ru-UA'} | ${'live'}   | ${'/ukrainian/topics/c0000000000t'}   | ${'https://mock-bff-path/?id=c0000000000t&service=ukrainian&pageType=topic&variant=ru-UA'}
  `(
