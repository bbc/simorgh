  ...
  describe('Request returns a non-200, non-404 status code', () => {
    ...
    describe('on server', () => {
      ...
      it('should log, and return the status code as 500', async () => {
        ...
        expect(loggerMock.error).toBeCalledWith(
          errorJson({
            message: `Error: Unexpected upstream response (HTTP status code 418) when requesting ${expectedUrl}`,
          }),
        );
      ...
      it('should log, and propogate the status code as 500', async () => {
        ...
        expect(loggerMock.error).toBeCalledWith(
          errorJson({
            message: `Error: Unexpected upstream response (HTTP status code 500) when requesting ${expectedUrl}`,
          }),
        );
