...
describe('constructPageFetchUrl', () => {
  ...
  it.each`
    ...
    ${ARTICLE_PAGE}    | ${null}         | ${null}    | ${'local'}  | ${'/ukrainian/articles/c0000000000o'}                 | ${'/ukrainian/articles/c0000000000o'}
    ...
    ${ARTICLE_PAGE}    | ${null}         | ${'ru-UA'} | ${'local'}  | ${'/ukrainian/articles/c0000000000o'}                 | ${'/ukrainian/articles/c0000000000o/ru-UA'}
    ...
    ${ARTICLE_PAGE}    | ${null}         | ${'ru-UA'} | ${'local'}  | ${'/ukrainian/articles/c00000000000o'}                | ${'/ukrainian/articles/c00000000000o/ru-UA'}
    ...
    ${ARTICLE_PAGE}    | ${'hausa'}      | ${null}    | ${'local'}  | ${'/hausa/news/2010/10/101020_majalisa_shugabankasa'} | ${'/hausa/news/2010/10/101020_majalisa_shugabankasa'}
    ...
    ${CPS_ASSET}       | ${null}         | ${null}    | ${'local'}  | ${'/ukrainian/23263889'}                              | ${'/ukrainian/23263889'}
    ...
    ${CPS_ASSET}       | ${null}         | ${null}    | ${'local'}  | ${'/ukrainian'}                                       | ${'/ukrainian'}
    ${CPS_ASSET}       | ${'serbian'}    | ${'cyr'}   | ${'local'}  | ${'/serbian/cyr'}                                     | ${'/serbian/cyr'}
    ...
    ${TOPIC_PAGE}      | ${null}         | ${null}    | ${'local'}  | ${'/ukrainian/topics/c0000000000t'}                   | ${'/ukrainian/topics/c0000000000t'}
    ...
    ${TOPIC_PAGE}      | ${null}         | ${'ru-UA'} | ${'local'}  | ${'/ukrainian/topics/c0000000000t'}                   | ${'/ukrainian/topics/c0000000000t/ru-UA'}
    ...
    ${TOPIC_PAGE}      | ${'persian'}    | ${null}    | ${'local'}  | ${'/persian/afghanistan'}                             | ${'/persian/topics/crezq2dg9zwt'}
    ...
    ${TOPIC_PAGE}      | ${'persian'}    | ${null}    | ${'local'}  | ${'/persian/topics/c0000000000t'}                     | ${'/persian/topics/c0000000000t'}
    ...
    ${TOPIC_PAGE}      | ${'persian'}    | ${null}    | ${'local'}  | ${'/persian/topics/c00000000000t'}                    | ${'/persian/topics/c00000000000t'}
    ...
    ${TOPIC_PAGE}      | ${'zhongwen'}   | ${'trad'}  | ${'local'}  | ${'/zhongwen/topics/cpydz21p02et/trad'}               | ${'/zhongwen/topics/cpydz21p02et/trad'}
    ${TOPIC_PAGE}      | ${'zhongwen'}   | ${'simp'}  | ${'local'}  | ${'/zhongwen/topics/c4vmr03pyn6t/simp'}               | ${'/zhongwen/topics/c4vmr03pyn6t/simp'}
    ...
    ${TV_PAGE}         | ${'hausa'}      | ${null}    | ${'local'}  | ${'/hausa/bbc_hausa_tv/tv/w172yjj83ptptnj'}           | ${'/hausa/bbc_hausa_tv/tv/w172yjj83ptptnj'}
    ${TV_PAGE}         | ${'hindi'}      | ${null}    | ${'local'}  | ${'/hindi/bbc_hindi_tv/tv_programmes/w13xttlw'}       | ${'/hindi/bbc_hindi_tv/tv_programmes/w13xttlw'}
    ...
    ${LIVE_RADIO_PAGE} | ${'afrique'}    | ${null}    | ${'local'}  | ${'/afrique/bbc_afrique_radio/liveradio'}             | ${'/afrique/bbc_afrique_radio/liveradio'}
