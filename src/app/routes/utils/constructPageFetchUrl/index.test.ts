...
describe('constructPageFetchUrl', () => {
  ...
  it.each`
    ...
    ${LIVE_PAGE}    | ${'zhongwen'}   | ${'trad'}  | ${'local'}  | ${'uk-69168527'}                                      | ${'http://localhost/api/local/zhongwen/trad/live/uk-69168527'}
    ...
    ${LIVE_PAGE}    | ${'zhongwen'}   | ${'trad'}  | ${'live'}   | ${'uk-69168527'}                                      | ${'https://mock-bff-path/?id=%2Fzhongwen%2Flive%2Fuk-69168527&service=zhongwen&pageType=live&variant=trad&serviceEnv=live'}
