...
describe('constructPageFetchUrl', () => {
  ...
  it.each`
    ...
    ${LIVE_PAGE}    | ${'arabic'}     | ${null}    | ${'local'}  | ${'/arabic/live/67574192'}            | ${'https://mock-bff-path/?id=%2Farabic%2Flive%2F%2Farabic%2Flive%2F67574192&service=arabic&pageType=live&serviceEnv=local'}
    ${LIVE_PAGE}    | ${'arabic'}     | ${null}    | ${'test'}   | ${'/arabic/live/67574192'}            | ${'https://mock-bff-path/?id=%2Farabic%2Flive%2F%2Farabic%2Flive%2F67574192&service=arabic&pageType=live&serviceEnv=test'}
    ${LIVE_PAGE}    | ${'arabic'}     | ${null}    | ${'live'}   | ${'/arabic/live/67574192'}            | ${'https://mock-bff-path/?id=%2Farabic%2Flive%2F%2Farabic%2Flive%2F67574192&service=arabic&pageType=live&serviceEnv=live'}
