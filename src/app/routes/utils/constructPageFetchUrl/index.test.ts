...
describe('constructPageFetchUrl', () => {
  ...
  it.each`
    ...
    ${CPS_ASSET}       | ${null}         | ${null}    | ${'local'}  | ${'/ukrainian'}                                                | ${'http://localhost/api/local/ukrainian'}
    ${CPS_ASSET}       | ${'serbian'}    | ${'cyr'}   | ${'local'}  | ${'/serbian/cyr'}                                              | ${'http://localhost/api/local/serbian/cyr'}
    ...
    ${TOPIC_PAGE}      | ${null}         | ${null}    | ${'local'}  | ${'/ukrainian/topics/c0000000000t'}                            | ${'http://localhost/api/local/ukrainian/topics/c0000000000t'}
    ...
    ${TOPIC_PAGE}      | ${null}         | ${'ru-UA'} | ${'local'}  | ${'/ukrainian/topics/c0000000000t'}                            | ${'http://localhost/api/local/ukrainian/topics/c0000000000t/ru-UA'}
    ...
    ${TOPIC_PAGE}      | ${'persian'}    | ${null}    | ${'local'}  | ${'/persian/topics/c0000000000t'}                              | ${'http://localhost/api/local/persian/topics/c0000000000t'}
    ...
    ${TOPIC_PAGE}      | ${'persian'}    | ${null}    | ${'local'}  | ${'/persian/topics/c00000000000t'}                             | ${'http://localhost/api/local/persian/topics/c00000000000t'}
    ...
    ${TOPIC_PAGE}      | ${'zhongwen'}   | ${'trad'}  | ${'local'}  | ${'/zhongwen/topics/cpydz21p02et/trad'}                        | ${'http://localhost/api/local/zhongwen/topics/cpydz21p02et/trad'}
    ${TOPIC_PAGE}      | ${'zhongwen'}   | ${'simp'}  | ${'local'}  | ${'/zhongwen/topics/c4vmr03pyn6t/simp'}                        | ${'http://localhost/api/local/zhongwen/topics/c4vmr03pyn6t/simp'}
    ...
    ${TV_PAGE}         | ${'hausa'}      | ${null}    | ${'local'}  | ${'/hausa/bbc_hausa_tv/tv/w172yjj83ptptnj'}                    | ${'http://localhost/api/local/hausa/bbc_hausa_tv/tv/w172yjj83ptptnj'}
    ${TV_PAGE}         | ${'hindi'}      | ${null}    | ${'local'}  | ${'/hindi/bbc_hindi_tv/tv_programmes/w13xttlw'}                | ${'http://localhost/api/local/hindi/bbc_hindi_tv/tv_programmes/w13xttlw'}
