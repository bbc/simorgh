...
describe('constructPageFetchUrl', () => {
  ...
  it.each`
    ...
    ${TV_PAGE}         | ${'hausa'}      | ${null}    | ${'test'}   | ${'/hausa/bbc_hausa_tv/tv/w172yjj83ptptnj'}           | ${'https://mock-bff-path/?id=hausa%2Fbbc_hausa_tv%2Ftv%w172yjj83ptptnj&service=hausa&pageType=tv&serviceEnv=test'}
    ...
    ${TV_PAGE}         | ${'hausa'}      | ${null}    | ${'live'}   | ${'/hausa/bbc_hausa_tv/tv/w172yjj83ptptnj'}           | ${'https://mock-bff-path/?id=hausa%2Fbbc_hausa_tv%2Ftv%w172yjj83ptptnj&service=hausa&pageType=tv&serviceEnv=live'}
