...
describe('processBlock', () => {
  ...
  it('should convert plain_text markup to candy_xml when the <link> tag is present', () => {
    const input = {
      text: 'paragraph including link <link><caption>this is a caption</caption><url href="www.example.com" platform="highweb"/></link>',
      markupType: 'plain_text',
      type: 'paragraph',
    };
  ...
  it('should convert plain_text markup to candy_xml with <link> tags in the legacy format (i.e. with attributes)', () => {
    const input = {
      text: '<link type="page"><caption>Desaparece en el mar Natalia Molchanova, la apneísta con más récords de la historia</caption><url href="http://www.bbc.com/mundo/noticias/2015/08/150804_deportes_desaparece_buzo_apnea_natalia_molchanova_ng" platform="highweb"/></link>',
      markupType: 'plain_text',
      type: 'paragraph',
    };
