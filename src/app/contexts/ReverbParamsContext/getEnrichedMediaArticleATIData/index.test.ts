...
import getEnrichedMediaArticleATIData from '.';
...
const serviceContext = { brandName: 'Brand Name' };

describe('getEnrichedMediaArticleATIData', () => {
  it('should include the brand name in the pageTitle for Media Article pages', () => {
    const enrichedData = getEnrichedMediaArticleATIData({
      pageMetadata,
      serviceContext,
    });
