...
const MAP = {
  ...
  metadata: {
    ...
    analyticsLabels: {
      ...
      pageIdentifier: 'pageIdentifier',
      pageTitle: 'pageTitle',
      contentId: 'urn:bbc:cps:curie:asset:4d36f80b-8711-0b4e-8da0-ef76ae8ac470',
    },
  ...
  describe('buildATIEventTrackingParams', () => {
    ...
    it('should return the right MAP params', () => {
      ...
      expect(params).toEqual({
        ...
        contentId:
          'urn:bbc:cps:curie:asset:4d36f80b-8711-0b4e-8da0-ef76ae8ac470',
