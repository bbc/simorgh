...
const testCases = [
  {
    ...
    expected: `https://www.bbc.co.uk/ws/av-embeds/articles/${assetId}/${vpid}`,
    embedObject: {
  ...
  },
  {
    ...
    expected: `https://www.test.bbc.com/ws/av-embeds/articles/${assetId}/${vpid}`,
    embedObject: {
  ...
  },
  {
    ...
    expected: `https://www.test.bbc.co.uk/ws/av-embeds/articles/${assetId}/${vpid}`,
    embedObject: {
  ...
  },
  {
    ...
    expected: `https://www.bbc.co.uk/ws/av-embeds/articles/${assetId}/${vpid}/amp`,
    embedObject: {
      origin: 'https://www.bbc.co.uk',
      isAmp: true,
      assetId,
  ...
  },
  {
    ...
    expected: `https://www.test.bbc.com/ws/av-embeds/articles/${assetId}/${vpid}/amp`,
    embedObject: {
      origin: 'https://www.test.bbc.com',
      isAmp: true,
      assetId,
  ...
  },
  {
    ...
    expected: `https://www.test.bbc.co.uk/ws/av-embeds/articles/${assetId}/${vpid}/amp`,
    embedObject: {
      origin: 'http://localhost.bbc.co.uk:7080',
      isAmp: true,
      assetId,
