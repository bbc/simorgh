...
export const GROUP_A_MIN_WIDTH = `@media (min-width: ${GROUP_A_MIN_WIDTH_BP}rem)`;
export const GROUP_A_ONLY = `@media (min-width: ${GROUP_A_MIN_WIDTH_BP}rem) and (max-width: ${GROUP_A_MAX_WIDTH_BP}rem)`;
