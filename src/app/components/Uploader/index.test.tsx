...
import { pidginEmbedUgcUploader, uploaderWithIncorrectType } from './fixtures';

describe('Uploader', () => {
  it('should render a section with role region', () => {
    render(<Uploader blocks={pidginEmbedUgcUploader} />);
    const region = screen.getByRole('region');
    expect(region).toBeInTheDocument();
  });

  it('should have a title with an id which matches the aria-labelledby attribute', () => {
    const { getByRole } = render(<Uploader blocks={pidginEmbedUgcUploader} />);
