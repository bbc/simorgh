...
const mobileImageMaskRed = `
  rgba(${maskColours.red}) 0%,
  rgba(${maskColours.white}, 0.99) 7%,
  ...
  rgba(${maskColours.white}, 0) 100%
`;
...
const group4MaskRed = `
  rgba(${maskColours.red}) 0%,
  rgba(${maskColours.red}) 50%,
  rgba(${maskColours.red}) 54%,
  rgba(${maskColours.red}, 0.98) 56%,
  rgba(${maskColours.white}, 0.96) 58%,
  rgba(${maskColours.white}, 0.93) 60%,
  rgba(${maskColours.white}, 0.89) 62%,
  rgba(${maskColours.white}, 0.84) 64%,
...
const extraWideMaskRed = `
  ...
  rgba(${maskColours.white}, 0.96) 22%,
  rgba(${maskColours.white}, 0.98) 23%,
  rgba(${maskColours.red}) 24%,
  rgba(${maskColours.red}) 25%,
  rgba(${maskColours.red}) 50%,
  rgba(${maskColours.red}) 54%,
  rgba(${maskColours.white}, 0.98) 56%,
  rgba(${maskColours.white}, 0.96) 58%,
...
export default {
  ...
  linearGradientLtr: ({ mq }: Theme) =>
    css({
      [mq.GROUP_4_MIN_WIDTH]: {
        maskImage: `linear-gradient(
          270deg, ${group4MaskRed})`, // 270deg for LTR
      },
      [mq.GROUP_5_MIN_WIDTH]: {
        maskImage: `linear-gradient(
          270deg, ${extraWideMaskRed})`, // 270deg for LTR
      },
    }),
  linearGradientRtl: ({ mq }: Theme) =>
    css({
      [mq.GROUP_4_MIN_WIDTH]: {
        maskImage: `linear-gradient(
          90deg, ${group4MaskRed})`, // 90deg for RTL
      },
      [mq.GROUP_5_MIN_WIDTH]: {
        maskImage: `linear-gradient(
          90deg, ${extraWideMaskRed})`, // 90deg for RTL
      },
    }),
};
