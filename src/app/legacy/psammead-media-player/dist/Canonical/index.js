...
var Canonical = function Canonical(_ref2) {
  ...
  var LoadingImageWrapper = (0, _base.default)("div", process.env.NODE_ENV === "production" ? {
    target: "eqo19v61"
  } : {
    target: "eqo19v61",
  ...
  var StyledIframe = (0, _base.default)("iframe", process.env.NODE_ENV === "production" ? {
    target: "eqo19v60"
  } : {
    target: "eqo19v60",
    label: "StyledIframe"
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(StyledIframe, {
    src: src,
    title: title,
    allow: "autoplay",
    scrolling: "no",
  ...
  }), showLoadingImage && /*#__PURE__*/_react.default.createElement(LoadingImageWrapper, null, /*#__PURE__*/_react.default.createElement(_psammeadImagePlaceholder.default, {
    ratio: 56.25,
    darkMode: darkMode
...
Canonical.propTypes = {
  ...
  showPlaceholder: _propTypes.bool.isRequired,
  showLoadingImage: _propTypes.bool.isRequired,
  darkMode: _propTypes.bool.isRequired,
  onMediaInitialised: _propTypes.func.isRequired,
  onMediaPlaying: _propTypes.func.isRequired,
  onMediaPause: _propTypes.func.isRequired,
  onMediaEnded: _propTypes.func.isRequired,
  onMediaPlaylistEnded: _propTypes.func.isRequired,
  onMediaError: _propTypes.func.isRequired,
