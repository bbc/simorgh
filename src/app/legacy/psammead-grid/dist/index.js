...
var groups = {
  group0: {
    min: null,
    max: _breakpoints.GEL_GROUP_0_SCREEN_WIDTH_MAX,
    gutterSize: _spacings.GEL_GUTTER_BELOW_600PX,
    marginSize: _spacings.GEL_MARGIN_BELOW_400PX
  },
  group1: {
    min: _breakpoints.GEL_GROUP_1_SCREEN_WIDTH_MIN,
    max: _breakpoints.GEL_GROUP_1_SCREEN_WIDTH_MAX,
    gutterSize: _spacings.GEL_GUTTER_BELOW_600PX,
    marginSize: _spacings.GEL_MARGIN_BELOW_400PX
  },
  group2: {
    min: _breakpoints.GEL_GROUP_2_SCREEN_WIDTH_MIN,
    max: _breakpoints.GEL_GROUP_2_SCREEN_WIDTH_MAX,
    gutterSize: _spacings.GEL_GUTTER_BELOW_600PX,
    marginSize: _spacings.GEL_MARGIN_ABOVE_400PX
  },
  group3: {
    min: _breakpoints.GEL_GROUP_3_SCREEN_WIDTH_MIN,
    max: _breakpoints.GEL_GROUP_3_SCREEN_WIDTH_MAX,
    gutterSize: _spacings.GEL_GUTTER_ABOVE_600PX,
    marginSize: _spacings.GEL_MARGIN_ABOVE_400PX
  },
  group4: {
    min: _breakpoints.GEL_GROUP_4_SCREEN_WIDTH_MIN,
    max: _breakpoints.GEL_GROUP_4_SCREEN_WIDTH_MAX,
    gutterSize: _spacings.GEL_GUTTER_ABOVE_600PX,
    marginSize: _spacings.GEL_MARGIN_ABOVE_400PX
  },
  group5: {
    min: _breakpoints.GEL_GROUP_5_SCREEN_WIDTH_MIN,
    max: null,
    gutterSize: _spacings.GEL_GUTTER_ABOVE_600PX,
    marginSize: _spacings.GEL_MARGIN_ABOVE_400PX
  }
...
var GridComponent = (0, _base.default)("div", process.env.NODE_ENV === "production" ? {
  target: "e57qer20"
} : {
  target: "e57qer20",
  label: "GridComponent"
...
var Grid = /*#__PURE__*/_react.default.forwardRef(function (_ref5, ref) {
  ...
  var renderGridComponent = function renderGridComponent() {
    return /*#__PURE__*/_react.default.createElement(GridComponent, _extends({}, otherProps, {
...
Grid.propTypes = {
  ...
  columns: (0, _propTypes.shape)({
    group1: _propTypes.number.isRequired,
    group2: _propTypes.number.isRequired,
    group3: _propTypes.number.isRequired,
    group4: _propTypes.number.isRequired,
    group5: _propTypes.number.isRequired
  }).isRequired,
  enableGelGutters: _propTypes.bool,
  enableNegativeGelMargins: _propTypes.bool,
  margins: (0, _propTypes.shape)({
    group1: _propTypes.bool,
    group2: _propTypes.bool,
    group3: _propTypes.bool,
    group4: _propTypes.bool,
    group5: _propTypes.bool
  }),
  startOffset: (0, _propTypes.shape)({
    group1: _propTypes.number,
    group2: _propTypes.number,
    group3: _propTypes.number,
    group4: _propTypes.number,
    group5: _propTypes.number
  }),
  item: _propTypes.bool,
  parentColumns: (0, _propTypes.shape)({
    group1: _propTypes.number,
    group2: _propTypes.number,
    group3: _propTypes.number,
    group4: _propTypes.number,
