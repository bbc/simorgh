  ...
  describe('buildATIUrl', () => {
    it('should return the right article url', () => {
      ...
      expect(url).toMatchInlineSnapshot(
        `"s=598285&s2=atiAnalyticsProducerId&p=service.articles.%2F%2Fwww.bbc.co.uk.page&r=0x0x24x24&re=1024x768&hl=00-00-00&lng=en-US&x1=[urn%3Abbc%3Aoptimo%3Aasset%3A54321]&x2=[responsive]&x3=[atiAnalyticsAppName]&x4=[language]&x5=[http%253A%252F%252Flocalhost%252F]&x6=[originhttp%253A%252F%252Fwww.example.com]&x7=[article]&x8=[simorgh]&x9=[pageTitle]&x10=[scotland]&x11=[1970-01-01T00%3A00%3A00.000Z]&x12=[1970-01-01T00%3A00%3A00.000Z]&x13=[thing%2520english%2520label%25201~thing%2520english%2520label%25202]&x14=[thing%2520id%25201~thing%2520id%25202]&ref=originhttp://www.example.com"`,
      );
    });
  ...
  describe('buildATIEventTrackingParams', () => {
    it('should return the right article params', () => {
      ...
      expect(params).toEqual({
        ...
        ldpThingLabels:
          'thing+english+label+1~thing+english+label+2',
        origin: 'origin',
