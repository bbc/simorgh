...
describe('ATI Analytics Container', () => {
  ...
  describe('pageType article', () => {
    it('should call CanonicalATIAnalytics when platform is canonical', () => {
      ...
      expect(mockCanonical.mock.calls[0][0]).toMatchInlineSnapshot(`
        Object {
          "pageviewParams": "s=598286&s2=64&p=news.articles.c0000000001o.page&r=0x0x24x24&re=1024x768&hl=00-00-00&lng=en-US&x1=[urn%3Abbc%3Aoptimo%3Ac0000000001o]&x2=[responsive]&x3=[news]&x4=[en-gb]&x5=[http%253A%252F%252Flocalhost%252F]&x7=[article]&x8=[simorgh]&x9=[Article+Headline+for+SEO]&x11=[1970-01-01T00%3A00%3A00.000Z]&x12=[1970-01-01T00%3A00%3A00.000Z]&x13=[Royal+Wedding+2018~Duchess+of+Sussex]&x14=[2351f2b2-ce36-4f44-996d-c3c4f7f90eaa~803eaeb9-c0c3-4f1b-9a66-90efac3df2dc]",
        }
      `);
    });
  ...
  describe('pageType=MAP', () => {
    it('should call CanonicalATIAnalytics when platform is canonical', () => {
      ...
      expect(mockAmp.mock.calls[0][0]).toMatchInlineSnapshot(`
        Object {
          "pageviewParams": "s=598343&s2=70&p=pidgin.media_asset.23248703.page&r=\${screenWidth}x\${screenHeight}x\${screenColorDepth}&re=\${availableScreenWidth}x\${availableScreenHeight}&hl=00-00-00&lng=\${browserLanguage}&x2=[amp]&x3=[news-pidgin]&x4=[pcm]&x5=[\${sourceUrl}]&x6=[\${documentReferrer}]&x7=[article-media-asset]&x8=[simorgh]&x9=[Simorgh%3A+Media+Pod+Build+First+CPS+Media+Asset+Page+in+Simorgh+%26+%3C+%3E+-+BBC+News+Pidgin]&x11=[1970-01-01T00%3A00%3A00.000Z]&x12=[1970-01-01T00%3A00%3A00.000Z]&x16=[Inspire+me~Give+me+perspective~Keep+me+on+trend]&x17=[Opinion]&ref=\${documentReferrer}",
        }
      `);
    });
  });
  ...
  describe('pageType=PGL', () => {
    it('should call CanonicalATIAnalytics when platform is canonical', () => {
      ...
      expect(mockCanonical.mock.calls[0][0]).toMatchInlineSnapshot(`
        Object {
          "pageviewParams": "s=598343&s2=6&p=azerbaijan%3A%3Aazeri.azerbaijan.photo_gallery.44208474.page&r=0x0x24x24&re=1024x768&hl=00-00-00&lng=en-US&x2=[responsive]&x3=[news-azeri]&x4=[az]&x5=[https%253A%252F%252Flocalhost]&x7=[article-photo-gallery]&x8=[simorgh]&x9=[Az%C9%99rbaycan+Xalq+C%C3%BCmhuriyy%C9%99ti+-+Fotolarda+-+BBC+News+Az%C9%99rbaycanca]&x11=[1970-01-01T00%3A00%3A00.000Z]&x12=[1970-01-01T00%3A00%3A00.000Z]&x13=[History~Azerbaijan~Society~Culture~Politics~Human+rights~Azerbaijan+Democratic+Republic+100th+anniversary~Caucasus~Law+and+order]&x14=[03eb3674-6190-4cd7-8104-1a00991d67a3~0f8e45e2-6499-44b1-be1f-1a3dd81e8af7~5307a8d9-f620-40f5-92d4-f99c919a6ffa~6a73afa3-ea6b-45c1-80bb-49060b99f864~75612fa6-147c-4a43-97fa-fcf70d9cced3~8b04c2e8-5409-4e7d-9877-3ccaf04727af~9e6f8e15-894a-45cb-9db9-d8881e8e6ae2~a86bc15e-ccd0-4ea9-9903-df3d4575a176~d94f45db-bb47-4e7b-b1a2-5bc3e6afd0aa]&x17=[News]",
        }
      `);
    });
    ...
    it('should call AmpATIAnalytics when platform is Amp', () => {
      ...
      expect(mockAmp.mock.calls[0][0]).toMatchInlineSnapshot(`
        Object {
          "pageviewParams": "s=598343&s2=6&p=azerbaijan%3A%3Aazeri.azerbaijan.photo_gallery.44208474.page&r=\${screenWidth}x\${screenHeight}x\${screenColorDepth}&re=\${availableScreenWidth}x\${availableScreenHeight}&hl=00-00-00&lng=\${browserLanguage}&x2=[amp]&x3=[news-azeri]&x4=[az]&x5=[\${sourceUrl}]&x6=[\${documentReferrer}]&x7=[article-photo-gallery]&x8=[simorgh]&x9=[Az%C9%99rbaycan+Xalq+C%C3%BCmhuriyy%C9%99ti+-+Fotolarda+-+BBC+News+Az%C9%99rbaycanca]&x11=[1970-01-01T00%3A00%3A00.000Z]&x12=[1970-01-01T00%3A00%3A00.000Z]&x13=[History~Azerbaijan~Society~Culture~Politics~Human+rights~Azerbaijan+Democratic+Republic+100th+anniversary~Caucasus~Law+and+order]&x14=[03eb3674-6190-4cd7-8104-1a00991d67a3~0f8e45e2-6499-44b1-be1f-1a3dd81e8af7~5307a8d9-f620-40f5-92d4-f99c919a6ffa~6a73afa3-ea6b-45c1-80bb-49060b99f864~75612fa6-147c-4a43-97fa-fcf70d9cced3~8b04c2e8-5409-4e7d-9877-3ccaf04727af~9e6f8e15-894a-45cb-9db9-d8881e8e6ae2~a86bc15e-ccd0-4ea9-9903-df3d4575a176~d94f45db-bb47-4e7b-b1a2-5bc3e6afd0aa]&x17=[News]&ref=\${documentReferrer}",
        }
      `);
    });
  });
  ...
  describe('pageType=STY', () => {
    it('should call CanonicalATIAnalytics when platform is canonical', () => {
      ...
      expect(mockCanonical.mock.calls[0][0]).toMatchInlineSnapshot(`
        Object {
          "pageviewParams": "s=598343&s2=62&p=mundo.story.23263889.page&r=0x0x24x24&re=1024x768&hl=00-00-00&lng=en-US&x2=[responsive]&x3=[news-mundo]&x4=[es]&x5=[https%253A%252F%252Flocalhost]&x7=[article]&x8=[simorgh]&x9=[WS+STY+TEST+-+Full+Headline+-+BBC+News+Mundo]&x11=[1970-01-01T00%3A00%3A00.000Z]&x12=[1970-01-01T00%3A00%3A00.000Z]&x13=[Life~Fake+news]&x14=[0239ab33-1cfc-4f5d-babb-a8159711af3e~e7539dc8-5cfb-413a-b4fe-0ad77bc665aa]&x16=[Amuse+me]&x17=[News]",
        }
      `);
    });
    ...
    it('should call AmpATIAnalytics when platform is Amp', () => {
      ...
      expect(mockAmp.mock.calls[0][0]).toMatchInlineSnapshot(`
        Object {
          "pageviewParams": "s=598343&s2=62&p=mundo.story.23263889.page&r=\${screenWidth}x\${screenHeight}x\${screenColorDepth}&re=\${availableScreenWidth}x\${availableScreenHeight}&hl=00-00-00&lng=\${browserLanguage}&x2=[amp]&x3=[news-mundo]&x4=[es]&x5=[\${sourceUrl}]&x6=[\${documentReferrer}]&x7=[article]&x8=[simorgh]&x9=[WS+STY+TEST+-+Full+Headline+-+BBC+News+Mundo]&x11=[1970-01-01T00%3A00%3A00.000Z]&x12=[1970-01-01T00%3A00%3A00.000Z]&x13=[Life~Fake+news]&x14=[0239ab33-1cfc-4f5d-babb-a8159711af3e~e7539dc8-5cfb-413a-b4fe-0ad77bc665aa]&x16=[Amuse+me]&x17=[News]&ref=\${documentReferrer}",
        }
      `);
    });
    ...
    it('should call AmpATIAnalytics when platform is Amp and pageType is CSP', () => {
      ...
      expect(mockAmp.mock.calls[0][0]).toMatchInlineSnapshot(`
        Object {
          "pageviewParams": "s=598343&s2=62&p=mundo.story.23263889.page&r=\${screenWidth}x\${screenHeight}x\${screenColorDepth}&re=\${availableScreenWidth}x\${availableScreenHeight}&hl=00-00-00&lng=\${browserLanguage}&x2=[amp]&x3=[news-mundo]&x4=[es]&x5=[\${sourceUrl}]&x6=[\${documentReferrer}]&x7=[article-correspondent]&x8=[simorgh]&x9=[WS+STY+TEST+-+Full+Headline+-+BBC+News+Mundo]&x11=[1970-01-01T00%3A00%3A00.000Z]&x12=[1970-01-01T00%3A00%3A00.000Z]&x13=[Life~Fake+news]&x14=[0239ab33-1cfc-4f5d-babb-a8159711af3e~e7539dc8-5cfb-413a-b4fe-0ad77bc665aa]&x16=[Amuse+me]&x17=[News]&ref=\${documentReferrer}",
        }
      `);
    });
    ...
    it('should return the correct language param when service is Ukrainian and pageData language is Ukrainian on canonical', () => {
      ...
      expect(mockCanonical.mock.calls[0][0]).toMatchInlineSnapshot(`
        Object {
          "pageviewParams": "s=598343&s2=94&p=news%3A%3Aukrainian.news.story.53561143.page&r=0x0x24x24&re=1024x768&hl=00-00-00&lng=en-US&x2=[responsive]&x3=[news-ukrainian]&x4=[uk]&x5=[https%253A%252F%252Flocalhost]&x7=[article]&x8=[simorgh]&x9=[%D0%92%D0%B8%D1%80%D0%BE%D0%B1%D0%BD%D0%B8%D1%86%D1%82%D0%B2%D0%BE+%D0%B3%D0%B5%D1%80%D0%BE%D1%97%D0%BD%D1%83+%D0%B7%D1%80%D0%BE%D1%81%D0%BB%D0%BE+%D0%B7%D0%B0%D0%B2%D0%B4%D1%8F%D0%BA%D0%B8+%D1%81%D0%BE%D0%BD%D1%8F%D1%87%D0%BD%D0%B8%D0%BC+%D0%B1%D0%B0%D1%82%D0%B0%D1%80%D0%B5%D1%8F%D0%BC.+%D0%9F%D0%BE%D0%B3%D0%BB%D1%8F%D0%B4+%D0%B7+%D0%91%D1%80%D0%B8%D1%82%D0%B0%D0%BD%D1%96%D1%97+-+BBC+News+%D0%A3%D0%BA%D1%80%D0%B0%D1%97%D0%BD%D0%B0]&x11=[1970-01-01T00%3A00%3A00.000Z]&x12=[1970-01-01T00%3A00%3A00.000Z]&x13=[Afghanistan~Drug+use~Drugs+trade~Ukraine]&x14=[1a5696c5-07d0-4a08-8b54-41ad5cd534b6~37cd3473-7b24-44b0-84c1-bf3c4801df5e~4b4cca1c-d458-4310-819e-dd48572b12c4~ee8750ed-a7fb-453f-bfca-2aa8b3fb064c]&x16=[WS+-+Educate+me]&x17=[News]",
        }
      `);
    });
    ...
    it('should return the correct language param when service is Ukrainian and pageData language is Ukrainian on Amp', () => {
      ...
      expect(mockAmp.mock.calls[0][0]).toMatchInlineSnapshot(`
        Object {
          "pageviewParams": "s=598343&s2=94&p=news%3A%3Aukrainian.news.story.53561143.page&r=\${screenWidth}x\${screenHeight}x\${screenColorDepth}&re=\${availableScreenWidth}x\${availableScreenHeight}&hl=00-00-00&lng=\${browserLanguage}&x2=[amp]&x3=[news-ukrainian]&x4=[uk]&x5=[\${sourceUrl}]&x6=[\${documentReferrer}]&x7=[article]&x8=[simorgh]&x9=[%D0%92%D0%B8%D1%80%D0%BE%D0%B1%D0%BD%D0%B8%D1%86%D1%82%D0%B2%D0%BE+%D0%B3%D0%B5%D1%80%D0%BE%D1%97%D0%BD%D1%83+%D0%B7%D1%80%D0%BE%D1%81%D0%BB%D0%BE+%D0%B7%D0%B0%D0%B2%D0%B4%D1%8F%D0%BA%D0%B8+%D1%81%D0%BE%D0%BD%D1%8F%D1%87%D0%BD%D0%B8%D0%BC+%D0%B1%D0%B0%D1%82%D0%B0%D1%80%D0%B5%D1%8F%D0%BC.+%D0%9F%D0%BE%D0%B3%D0%BB%D1%8F%D0%B4+%D0%B7+%D0%91%D1%80%D0%B8%D1%82%D0%B0%D0%BD%D1%96%D1%97+-+BBC+News+%D0%A3%D0%BA%D1%80%D0%B0%D1%97%D0%BD%D0%B0]&x11=[1970-01-01T00%3A00%3A00.000Z]&x12=[1970-01-01T00%3A00%3A00.000Z]&x13=[Afghanistan~Drug+use~Drugs+trade~Ukraine]&x14=[1a5696c5-07d0-4a08-8b54-41ad5cd534b6~37cd3473-7b24-44b0-84c1-bf3c4801df5e~4b4cca1c-d458-4310-819e-dd48572b12c4~ee8750ed-a7fb-453f-bfca-2aa8b3fb064c]&x16=[WS+-+Educate+me]&x17=[News]&ref=\${documentReferrer}",
        }
      `);
    });
    ...
    it('should return the correct language param when service is Ukrainian and pageData language is Russian on canonical', () => {
      ...
      expect(mockCanonical.mock.calls[0][0]).toMatchInlineSnapshot(`
        Object {
          "pageviewParams": "s=598343&s2=94&p=russian_features%3A%3Aukrainian.russian_features.story.53477115.page&r=0x0x24x24&re=1024x768&hl=00-00-00&lng=en-US&x2=[responsive]&x3=[news-ukrainian]&x4=[ru]&x5=[https%253A%252F%252Flocalhost]&x7=[article]&x8=[simorgh]&x9=[%D0%9A%D0%B0%D1%80%D1%82%D0%B0+%D0%BD%D0%BE%D0%B2%D1%8B%D1%85+%D1%80%D0%B0%D0%B9%D0%BE%D0%BD%D0%BE%D0%B2+%D0%A3%D0%BA%D1%80%D0%B0%D0%B8%D0%BD%D1%8B%3A+%D0%BA%D1%82%D0%BE+%D0%B8+%D0%BA%D0%BE%D0%B3%D0%BE+%D0%BF%D0%BE%D0%B3%D0%BB%D0%BE%D1%82%D0%B8%D0%BB+-+BBC+News+%D0%A3%D0%BA%D1%80%D0%B0%D1%97%D0%BD%D0%B0]&x11=[1970-01-01T00%3A00%3A00.000Z]&x12=[1970-01-01T00%3A00%3A00.000Z]&x13=[Society~Politics~Ukraine]&x14=[5307a8d9-f620-40f5-92d4-f99c919a6ffa~75612fa6-147c-4a43-97fa-fcf70d9cced3~ee8750ed-a7fb-453f-bfca-2aa8b3fb064c]&x16=[WS+-+Update+me]&x17=[News]",
        }
      `);
    });
  ...
  describe('XTO Marketing string', () => {
    ...
    it('should include the xto marketing string for a valid campaign type', () => {
      ...
      expect(mockCanonical.mock.calls[0][0]).toMatchInlineSnapshot(`
        Object {
          "pageviewParams": "s=598343&s2=62&p=mundo.story.23263889.page&r=0x0x24x24&re=1024x768&hl=00-00-00&lng=en-US&x2=[responsive]&x3=[news-mundo]&x4=[es]&x5=[https%253A%252F%252Flocalhost%253Fat_medium%253Demail%2526at_emailtype%253Dacquisition%2526at_creation%253Dmy_creation]&x7=[article]&x8=[simorgh]&x9=[WS+STY+TEST+-+Full+Headline+-+BBC+News+Mundo]&x11=[1970-01-01T00%3A00%3A00.000Z]&x12=[1970-01-01T00%3A00%3A00.000Z]&x13=[Life~Fake+news]&x14=[0239ab33-1cfc-4f5d-babb-a8159711af3e~e7539dc8-5cfb-413a-b4fe-0ad77bc665aa]&x16=[Amuse+me]&x17=[News]&xto=EREC--%5Bmy_creation%5D---%40",
        }
      `);
    });
    it('should not include the xto marketing string when a campaign type is not specified', () => {
      ...
      expect(mockCanonical.mock.calls[0][0]).toMatchInlineSnapshot(`
        Object {
          "pageviewParams": "s=598343&s2=62&p=mundo.story.23263889.page&r=0x0x24x24&re=1024x768&hl=00-00-00&lng=en-US&x2=[responsive]&x3=[news-mundo]&x4=[es]&x5=[http%253A%252F%252Flocalhost%253Ffoo%253Dbar]&x7=[article]&x8=[simorgh]&x9=[WS+STY+TEST+-+Full+Headline+-+BBC+News+Mundo]&x11=[1970-01-01T00%3A00%3A00.000Z]&x12=[1970-01-01T00%3A00%3A00.000Z]&x13=[Life~Fake+news]&x14=[0239ab33-1cfc-4f5d-babb-a8159711af3e~e7539dc8-5cfb-413a-b4fe-0ad77bc665aa]&x16=[Amuse+me]&x17=[News]",
        }
      `);
    });
  });
  describe('pageType=FIX', () => {
    it('should call CanonicalATIAnalytics when platform is canonical', () => {
      ...
      expect(mockCanonical.mock.calls[0][0]).toMatchInlineSnapshot(`
        Object {
          "pageviewParams": "s=598343&s2=3&p=afrique.feature_index.48465371.page&r=0x0x24x24&re=1024x768&hl=00-00-00&lng=en-US&x1=[urn%3Abbc%3Acps%3A447a95b6-1c9f-e544-bf60-e23452e7fa71]&x2=[responsive]&x3=[news-afrique]&x4=[fr]&x5=[http%253A%252F%252Flocalhost%252F]&x7=[index-section]&x8=[simorgh]&x9=[Tout+savoir+sur+la+CAN+2019+-+BBC+News+Afrique]&x11=[1970-01-01T00%3A00%3A00.000Z]&x12=[1970-01-01T00%3A00%3A00.000Z]",
        }
      `);
    });
    ...
    it('should call AmpATIAnalytics when platform is Amp', () => {
      ...
      expect(mockAmp.mock.calls[0][0]).toMatchInlineSnapshot(`
        Object {
          "pageviewParams": "s=598343&s2=3&p=afrique.feature_index.48465371.page&r=\${screenWidth}x\${screenHeight}x\${screenColorDepth}&re=\${availableScreenWidth}x\${availableScreenHeight}&hl=00-00-00&lng=\${browserLanguage}&x1=[urn%3Abbc%3Acps%3A447a95b6-1c9f-e544-bf60-e23452e7fa71]&x2=[amp]&x3=[news-afrique]&x4=[fr]&x5=[\${sourceUrl}]&x6=[\${documentReferrer}]&x7=[index-section]&x8=[simorgh]&x9=[Tout+savoir+sur+la+CAN+2019+-+BBC+News+Afrique]&x11=[1970-01-01T00%3A00%3A00.000Z]&x12=[1970-01-01T00%3A00%3A00.000Z]&ref=\${documentReferrer}",
        }
      `);
    });
  });
