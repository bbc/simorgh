...
describe('Consent Banner Container', () => {
  it('should return null for amp banner when country-based cookie logic is enabled', () => {
  ...
  shouldMatchSnapshot(
    'should correctly render amp banner when country-based cookie logic is disabled',
    <RequestContextProvider
      bbcOrigin="https://www.test.bbc.co.uk"
      id="c0000000000o"
      isAmp
