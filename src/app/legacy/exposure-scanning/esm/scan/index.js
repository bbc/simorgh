var replacementStr = '*';
export var scanText = function scanText(text, regex) {
...
export var scanComments = function scanComments(comments, regex) {
...
export var scanPr = function scanPr(pr, regex) {
  try {
...
export var scanIssue = function scanIssue(issue, regex) {
  try {
