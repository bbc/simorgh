...
exports.SubHeading = exports.Headline = void 0;
...
var Headline = (0, _base.default)("h1", process.env.NODE_ENV === "production" ? {
  target: "e14hemmw1"
} : {
  target: "e14hemmw1",
  label: "Headline"
  ...
  return script && (0, _typography.getCanon)(script);
}, ";", function (_ref2) {
...
var SubHeading = (0, _base.default)("h2", process.env.NODE_ENV === "production" ? {
  target: "e14hemmw0"
} : {
  target: "e14hemmw0",
  label: "SubHeading"
