...
var StyledSpan = _styled("span", process.env.NODE_ENV === "production" ? {
  target: "effkio50"
} : {
  target: "effkio50",
  label: "StyledSpan"
...
}, " color:", C_POSTBOX, ";display:inline-block;", function (_ref2) {
  var dir = _ref2.dir;
...
var LiveLabel = function LiveLabel(_ref3) {
  ...
  return (
    ...
    React.createElement("span", {
      role: "text"
    }, /*#__PURE__*/React.createElement(StyledSpan, _extends({
      service: service,
      dir: dir
    }, ariaHidden && {
      'aria-hidden': 'true'
    }), "".concat(liveText, " ")), offScreenText && /*#__PURE__*/React.createElement(VisuallyHiddenText, {
      lang: lang
