...
var BulletedList = _styled(
  ...
  ";margin-top:0;list-style-type:none;&>li{position:relative;}&>li::before{top:0.5rem;content:' ';position:absolute;border-width:1rem;border:0.1875rem solid ",
  function (_ref3) {
...
export var BulletedListItem = _styled(
  'li',
  process.env.NODE_ENV === 'production'
    ? {
        target: 'e1drcs2w0',
