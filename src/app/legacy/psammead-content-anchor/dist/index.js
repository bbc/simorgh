...
var getSize = (0, _when.default)((0, _is.default)(Number), convertToPixels);
...
var initResizeObserver = function initResizeObserver(_ref8) {
  ...
  return Promise.resolve().then(function () {
    return _interopRequireWildcard(require('@juggle/resize-observer'));
...
var ContentAnchor = function ContentAnchor(_ref11) {
  ...
  var scrollHeight = (0, _react.useRef)(null);
  var scrollAnchoringIsSupported = (0, _react.useRef)(null);
...
ContentAnchor.propTypes = {
  ...
  initialHeight: (0, _propTypes.oneOfType)([_propTypes.number, _propTypes.string]),
  initialWidth: (0, _propTypes.oneOfType)([_propTypes.number, _propTypes.string])
};
ContentAnchor.defaultProps = {
  initialHeight: 'auto',
  initialWidth: 'auto'
};
var _default = ContentAnchor;
