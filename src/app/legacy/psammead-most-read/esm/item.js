...
import { getFoolscap, getDoublePica } from '#legacy/gel-foundations/typography';
import { C_EBON, C_POSTBOX } from '#legacy/psammead-styles/colours';
...
var StyledLink =
  ...
  styled.a.withConfig({
    ...
    [
      ...
      ';',
      ' color:',
      ';text-decoration:none;padding-bottom:',
