...
exports.visuallyHiddenStyle = exports.dictionaryFactory = exports.detokenise = exports.getProviderName = void 0;

/**
 * Returns a string of a known provider name.
 * @param {String} provider A given provider.
 */
var getProviderName = function getProviderName(provider) {
...
var dictionaryFactory = function dictionaryFactory(_ref) {
