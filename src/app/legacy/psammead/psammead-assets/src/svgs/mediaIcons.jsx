...
const MediaIcon = ({ children, className = '', ...props }) => (
  <svg
    className={`align-middle mx-half text-ebon fill-current ${className}`}
    focusable="false"
    aria-hidden="true"
    {...props}
  >
...
const VideoMediaIcon = ({ children, ...props }) => (
  <MediaIcon
    className="w-3 h-3"
    viewBox="0 0 12 12"
    width="12"
...
const AudioMediaIcon = ({ children, ...props }) => (
  <MediaIcon
    className="w-3 h-3"
    viewBox="0 0 13 12"
    width="13px"
...
const PhotoMediaIcon = ({ children, ...props }) => (
  <MediaIcon
    className="w-full h-[0.8125rem]"
    viewBox="0 0 32 26"
    width="16px"
    height="13px"
    {...props}
...
const GuidanceIcon = ({ children, ...props }) => (
  <MediaIcon
...
const PodcastIcon = ({ children, ...props }) => (
  <MediaIcon
    className="w-full h-full .podcastIconWrapper_&:w-quad .podcastIconWrapper_&:h-quad .podcastIconWrapper_&:m-auto max-[16.25rem]:.podcastIconWrapper_&:w-triple max-[16.25rem]:.podcastIconWrapper_&:h-triple"
    viewBox="0 0 32 32"
    width="32"
    height="32"
    {...props}
...
const SeriesStackIcon = ({ children, ...props }) => (
  <MediaIcon
    className="w-full h-full"
    viewBox="0 0 32 32"
    width="32"
