...
The `product` is passed to a [VisuallyHiddenText](../../../components/VisuallyHiddenText/README.md) component, nested inside Brand.



The `serviceLocalisedName` is an optional prop referring to the local name of a service eg `Yoruba`. It is also passed to [VisuallyHiddenText](../../../components/VisuallyHiddenText/README.md) inside the Brand component.
