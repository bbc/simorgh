...
describe('Media Player: AMP Entry', () => {
  ...
  it('should render a portrait container with amp-iframe and nested amp-img', () => {
    const { container } = render(
      <AmpMediaPlayer
        portrait
        placeholderSrc="http://foo.bar/placeholder.png"
  ...
  it('should render the audio skin', () => {
    const { container } = render(
      <AmpMediaPlayer
...
describe('Media Player: Canonical Entry', () => {
  ...
  it('should render a landscape container with a placeholder image', () => {
    const { container } = render(
  ...
  it('should render a portrait container with a placeholder image', () => {
    const { container } = render(
      <CanonicalMediaPlayer
        placeholderSrc="http://foo.bar/placeholder.png"
        src="http://foo.bar/iframe"
  ...
  it('should render an iframe when showPlaceholder is false', () => {
    const { container } = render(
      <CanonicalMediaPlayer
        showPlaceholder={false}
        src="http://foo.bar/iframe"
  ...
  it('should render a placeholder image with guidance', () => {
    const { container } = render(
      <CanonicalMediaPlayer
        placeholderSrc="http://foo.bar/placeholder.png"
        src="http://foo.bar/iframe"
  ...
  it('should show a loading image before the player is ready when showLoadingImage is true', () => {
    const { container } = render(
      <CanonicalMediaPlayer
        src="http://foo.bar/iframe"
        showPlaceholder={false}
  ...
  it('should render with no-js styles when noJsClassName prop is used', () => {
    const { container } = render(
      <CanonicalMediaPlayer
        placeholderSrc="http://foo.bar/placeholder.png"
        src="http://foo.bar/iframe"
