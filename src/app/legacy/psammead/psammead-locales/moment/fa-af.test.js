...
test('format', () => {
  const a = [
    [
      ...
      'یک‌شنبه، ثور ۱۴م ۲۰۱۰، ۳:۲۵:۵۰ بعد از ظهر',
    ],
    ['ddd, hA', 'یک\u200cشنبه، ۳بعد از ظهر'],
    ['M Mo MM MMMM MMM', '۲ ۲م ۰۲ ثور ثور'],
    ['YYYY YY', '۲۰۱۰ ۱۰'],
    ['D Do DD', '۱۴ ۱۴م ۱۴'],
    ...
    ['L', '۱۴/۰۲/۲۰۱۰'],
    ['LL', '۱۴ ثور ۲۰۱۰'],
    ['LLL', '۱۴ ثور ۲۰۱۰ ۱۵:۲۵'],
    ['LLLL', 'یک‌شنبه، ۱۴ ثور ۲۰۱۰ ۱۵:۲۵'],
    ['l', '۱۴/۲/۲۰۱۰'],
    ['ll', '۱۴ ثور ۲۰۱۰'],
    ['lll', '۱۴ ثور ۲۰۱۰ ۱۵:۲۵'],
    ['llll', 'یک‌شنبه، ۱۴ ثور ۲۰۱۰ ۱۵:۲۵'],
...
test('format month', () => {
  const expected = months.map((month) => `${month} ${month}`);
  let i;
