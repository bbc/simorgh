...
export var shouldMatchSnapshot = function shouldMatchSnapshot(title, component) {
  it(title, function () {
...
export var isNull = function isNull(title, component) {
  it(title, function () {
...
export var setWindowValue = function setWindowValue(key, value) {
  var windowValue = window[key];
  delete window[key];
  var newValue = value;

  if (value && _typeof(value) === 'object') {
    newValue = _objectSpread(_objectSpread({}, deepClone(windowValue)), value);
  }
...
export var resetWindowValue = function resetWindowValue(key, value) {
  Object.defineProperty(window, key, {
    value: value,
    writable: true
  });
};
export var suppressPropWarnings = function suppressPropWarnings(warnings) {
  var _window = window,
...
export var testUtilityPackages = function testUtilityPackages(actualExports, expectedExports, packageName) {
