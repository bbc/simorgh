...
var TextGridColumns = function TextGridColumns(displayImage) {
  return '\n  grid-column: 3 / span 4;\n\n  '
    ...
    .concat(displayImage ? GEL_SPACING : '0', ';\n  }\n');
};
...
var TextGridItem = _styled(
  ...
  '@supports (',
  grid,
  '){display:block;width:initial;padding:initial;',
  function (_ref5) {
