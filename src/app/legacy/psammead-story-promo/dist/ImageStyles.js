...
var gridFallbackImageWidth = "\n  width: calc(".concat(halfWidthColumnsMaxScaleable, " - ").concat(_spacings.GEL_SPACING, ");\n");
var ImageGridColumnsTopStory = "\n  grid-column: 1 / span 6;\n\n  @media (min-width: ".concat(_breakpoints.GEL_GROUP_3_SCREEN_WIDTH_MIN, ") and (max-width: ").concat(_breakpoints.GEL_GROUP_4_SCREEN_WIDTH_MAX, ") {\n    grid-column: 1 / span 3;\n  }\n");
...
}, "@supports (", _detection.grid, "){width:initial;", function (_ref2) {
