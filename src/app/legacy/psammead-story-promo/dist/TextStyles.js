...
var leadingPromoTimestampPadding = "\n  >time {\n    @media (max-width: ".concat(_breakpoints.GEL_GROUP_3_SCREEN_WIDTH_MAX, ") {\n      padding-bottom: ").concat(_spacings.GEL_SPACING, ";\n    }\n  }\n");
var TextGridItem = (0, _base.default)("div", process.env.NODE_ENV === "production" ? {
  target: "e19k1v2h0"
} : {
  target: "e19k1v2h0",
  label: "TextGridItem"
...
}, "@supports (", _detection.grid, "){display:block;width:initial;padding:initial;", function (_ref5) {
