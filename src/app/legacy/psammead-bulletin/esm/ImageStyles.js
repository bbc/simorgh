...
var ImageGridItem = _styled("div", process.env.NODE_ENV === "production" ? {
  ...
  target: "efdpnwp0",
  label: "ImageGridItem"
})("vertical-align:top;display:inline-block;width:", fullWidthColumnsMaxScaleable, ";padding:", GEL_SPACING, " ", GEL_SPACING, " 0 ", GEL_SPACING, ";", function (_ref) {
  var bulletinType = _ref.bulletinType;
  return imageGridFallbackStyles[bulletinType];
}, "@media (min-width: ", GEL_GROUP_3_SCREEN_WIDTH_MIN, "){padding:0;}@supports (", grid, "){width:initial;grid-column:1/span 6;", function (_ref2) {
