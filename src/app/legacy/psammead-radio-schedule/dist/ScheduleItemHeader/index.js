...
var _psammeadLiveLabel = _interopRequireDefault(require("@bbc/psammead-live-label"));

var _propTypes2 = require("@bbc/gel-foundations/prop-types");

var _psammeadStoryPromo = require("@bbc/psammead-story-promo");
...
var _utilities2 = _interopRequireWildcard(require("../utilities"));
...
var TitleWrapper = (0, _base.default)("span", process.env.NODE_ENV === "production" ? {
  target: "e1b8rgsx2"
} : {
  target: "e1b8rgsx2",
  label: "TitleWrapper"
  ...
  return titleColor;
}, ";padding:", _spacings.GEL_SPACING, " 0;display:inline-block;width:100%;", function (_ref2) {
...
var StyledLink = ( /*#__PURE__*/0, _base.default)(_psammeadStoryPromo.Link, process.env.NODE_ENV === "production" ? {
  target: "e1b8rgsx1"
} : {
  target: "e1b8rgsx1",
  label: "StyledLink"
...
var NextLabel = (0, _base.default)("span", process.env.NODE_ENV === "production" ? {
  target: "e1b8rgsx0"
} : {
  target: "e1b8rgsx0",
  label: "NextLabel"
  ...
  return service && (0, _fontStyles.getSansBold)(service);
}, ";", function (_ref5) {
  var script = _ref5.script;
  return script && (0, _typography.getPica)(script);
}, ";color:", _colours.C_KINGFISHER, ";display:inline-block;", function (_ref6) {
  var dir = _ref6.dir;
...
var ScheduleItemHeader = function ScheduleItemHeader(_ref7) {
  ...
  var formattedStartTime = (0, _utilities.formatUnixTimestamp)({
    timestamp: startTime,
    format: 'HH:mm',
    timezone: timezone,
    locale: locale,
  ...
  var formattedDuration = (0, _psammeadDetokeniser.default)(durationLabel, (0, _utilities2.default)({
    duration: duration,
    locale: locale
  }));
  var episodeTitle = (0, _utilities.formatUnixTimestamp)({
    timestamp: startTime,
    format: 'LL',
    timezone: timezone,
    locale: locale,
  ...
  _react.default.createElement("span", {
    role: "text"
  }, /*#__PURE__*/_react.default.createElement(_psammeadVisuallyHiddenText.default, null, "".concat(listenLabelTranslations[state], ", ")), isLive && /*#__PURE__*/_react.default.createElement(_psammeadLiveLabel.default, {
    service: service,
    dir: dir,
    liveText: liveLabel,
    ariaHidden: true
  }), isNext && /*#__PURE__*/_react.default.createElement(NextLabel, {
    "aria-hidden": "true",
    service: service,
    script: script,
    dir: dir
  }, "".concat(nextLabel, " ")), brandTitle, /*#__PURE__*/_react.default.createElement(_psammeadVisuallyHiddenText.default, null, ", ", formattedStartTime, ", "), /*#__PURE__*/_react.default.createElement(TitleWrapper, _extends({
    service: service,
    script: script
  }, _utilities2.programStateConfig[state]), episodeTitle), /*#__PURE__*/_react.default.createElement(_psammeadVisuallyHiddenText.default, null, ", ".concat(formattedDuration, " ")));

  var linkProps = _defineProperty({}, linkComponentAttr, link);

  return state === 'next' ? content : /*#__PURE__*/_react.default.createElement(StyledLink, _extends({
    as: linkComponent
  }, linkProps), content);
};
...
ScheduleItemHeader.propTypes = {
  ...
  brandTitle: _propTypes.string.isRequired,
  link: _propTypes.string.isRequired,
  state: _propTypes.string.isRequired,
  nextLabel: _propTypes.string.isRequired,
  liveLabel: _propTypes.string.isRequired,
  listenLabelTranslations: (0, _propTypes.shape)({
    live: _propTypes.string.isRequired,
    next: _propTypes.string.isRequired,
    onDemand: _propTypes.string.isRequired
  }).isRequired,
  ...
  linkComponent: (0, _propTypes.oneOfType)([_propTypes.elementType, _propTypes.string]),
  linkComponentAttr: _propTypes.string
};
...
var _default = ScheduleItemHeader;
