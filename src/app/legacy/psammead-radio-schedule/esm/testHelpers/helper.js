...
import { arabic, latin } from '#legacy/gel-foundations/scripts';
    ...
    return {
      ...
      summary:
        withLongSummary && state === 'live'
          ? ''.concat(longText, ' ').concat(longText)
          : longText,
      duration: 'PT1H',
...
export var renderProgramCard = function renderProgramCard(_ref) {
  var state = _ref.state,
    ...
    displaySummary =
      _ref$displaySummary === void 0
        ? boolean('show summary', true)
        : _ref$displaySummary,
    ...
    linkComponentAttr =
      _ref$linkComponentAtt === void 0 ? 'href' : _ref$linkComponentAtt;
...
export var renderRadioSchedule = function renderRadioSchedule(_ref2) {
  var _ref2$service = _ref2.service,
    ...
    withLongSummary =
      _ref2$withLongSummary === void 0 ? false : _ref2$withLongSummary,
    _ref2$selectedService = _ref2.selectedService,
    selectedService =
      _ref2$selectedService === void 0 ? 'news' : _ref2$selectedService,
    ...
    linkComponentAttr =
      _ref2$linkComponentAt === void 0 ? 'href' : _ref2$linkComponentAt;
