...
import { GEL_SPACING_HLF } from '#legacy/gel-foundations/spacings'; // `currentColor` has been used to better reflect user colour choices in Firefox.
...
var MediaIcon =
  ...
  styled.svg.withConfig({
    ...
    ['vertical-align:middle;margin:0 ', ';color:', ';fill:currentColor;'],
    GEL_SPACING_HLF,
    C_EBON,
  );
var VideoMediaIcon =
...
var icons = {
  ...
  photogallery: React.createElement(
    PhotoMediaIcon,
    {
      viewBox: '0 0 32 26',
      width: '16px',
