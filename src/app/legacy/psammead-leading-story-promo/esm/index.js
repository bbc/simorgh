...
import { getDoublePica } from '#legacy/gel-foundations/dist/typography';
...
var LeadingPromoWrapper =
  ...
  styled.div.withConfig({
    ...
    [
      '@supports (',
      '){display:grid;grid-template-columns:repeat(6,1fr);grid-column-gap:',
      ';}',
    ],
    grid,
    GEL_SPACING_DBL,
...
var LeadingStoryPromo = function LeadingStoryPromo(_ref3) {
  ...
  return React.createElement(
    LeadingPromoWrapper,
    null,
    React.createElement(TextGridItem, null, info),
    React.createElement(ImageGridItem, null, image),
  );
};
