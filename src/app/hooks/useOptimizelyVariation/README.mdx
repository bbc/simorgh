...
import useOptimizely from '#hooks/useOptimizelyVariation';

const ExamplePage = () => {
  const variation = useOptimizelyVariation({ experimentName: 'foo-experiment-id', runtimeType: ExperimentState.CLIENT_SIDE});
