...
describe('getIchefURL', () => {
  it('builds standard ichef img url based on originCode, locator, resolution passed', () => {
    ...
    const expectedOutput =
      'https://ichef.bbci.co.uk/ace/standard/660/cpsprodpb/cc66/live/5b34d420-b382-11e9-b6fd-e3056fffd1f1.jpg';
  ...
  it('builds WebP ichef img url based on originCode, locator, resolution and isWebP passed', () => {
    ...
    const expectedOutput =
      'https://ichef.bbci.co.uk/ace/standard/660/cpsprodpb/cc66/live/5b34d420-b382-11e9-b6fd-e3056fffd1f1.jpg.webp';
  ...
  it('builds standard ichef img url based on originCode, locator, resolution and isWebP passed', () => {
    ...
    const expectedOutput =
      'https://ichef.bbci.co.uk/ace/standard/660/amz/worldservice/live/assets/images/2013/08/19/130819164754_ardeshir_zahedi_112x63_bbc_nocredit.jpg';
