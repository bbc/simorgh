...
describe('getIchefURL', () => {
  ...
  describe('builds WebP ichef img url based on originCode, locator and resolution passed', () => {
    ...
    it.each`
      ...
      ${'ace/ws'}       | ${'cpsdevpb'}  | ${'2F4D/test/_63490121_110329105535_soweto_304x171_b_nocredit.gif'}                                  | ${`${BASE_IMAGE_URL}/ace/ws/660/cpsdevpb/2F4D/test/_63490121_110329105535_soweto_304x171_b_nocredit.gif`}
