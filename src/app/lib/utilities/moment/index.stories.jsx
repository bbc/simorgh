...
const methods = [
...

  {
    ...
    method: (locale) =>
      moment().locale(locale).subtract(1, 'seconds').fromNow(),
  },
  {
    what: '5 seconds in the past',
    method: (locale) =>
      moment().locale(locale).subtract(5, 'seconds').fromNow(),
  },
  {
    what: '1 minute in the past',
    method: (locale) =>
      moment().locale(locale).subtract(1, 'minutes').fromNow(),
  },
  {
    what: '5 minutes in the past',
    method: (locale) =>
      moment().locale(locale).subtract(5, 'minutes').fromNow(),
  },
  {
