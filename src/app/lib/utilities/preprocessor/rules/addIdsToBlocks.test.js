...
describe('addIdsToBlocks rule', () => {
  it('should recursively add ids to blocks in article data', async () => {
    const actual = await addIdsToBlocks(articleJson);

    expect(actual).toEqual(expected);
  });

  it('should recursively add ids to blocks in article data as a promise', async () => {
    const actual = await addIdsToBlocks(Promise.resolve(articleJson));
