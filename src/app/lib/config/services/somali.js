...
export const service = {
  ...
  "amp": {
    ...
    "initial": {
      ...
      "description": {
        "first": "Anaga iyo baraha aan ogolnahay nahay waxaan adeegsanaa teknolijiyad sida ",
        "linkText": "cookies",
    ...
    "manage": {
      ...
      "description": {
        "para1": "Qeybahan waxay quseeyaan bogagga AMP oo keli ah. Markale waa lagu weydiin karaa in aad wax ka bedesho, marka aad booqato bogagga BBC ee aan AMP ahayn.",
        "para2": "Bogagga fudud ee Mobile-ka ee aad booqatay waxaa lagu dhisay isticmaalka tiknolojiyadda Google AMP.",
        "heading2": "Wuxuu ku kooban yahay oo keli ah xogta aan laga maarmin.",
        "para3": "Si ay bogaggeena web-ka u shaqeeyaa, waxaan xog kooban ku keydineynaa qalabkaaga, adigoo aan ogolaan.",
        "para4": {
        ...
        "para5": "Waxaan isticmaaleynaa keydin gudaha ah si aan ogolaanshahaaga ugu keydino qalabkaaga gudihiisa.",
        "heading3": "Xog uruurinta ikhtiyaariga ah",
        "para6": "Marka aad ogolaato xog uruurinta bogagga AMP waxaad ogolaaneysaa oo aad inoo fasexeysaa in aad ku tusno xayeysiin xiriir kula leh, marka aad ku sugan tahay meel ka baxsan UK.",
        "para7": {
        ...
        "para8": "Waad dooran kartaa in aanan lagu soo gaarsiin xayeysiin xiriirka kula leh adigoo gujinaya \"Diid xog uruurinta siina soco\" ee hoose. Fadlan ogow weli waad arkeysaa xayeysiis, balse ma noqoneyso mid kula xiriirta.",
        "para9": "Waad bedeli kartaa qeybahan adigoo gujinaya \"dookha xayeysiin / Ha iibin xogteyda\" ee kuu soo muuqaneysa, markasta."
      }
    }
  },
  "canonical": {
    "title": "Aan ogaano in aad aqbashay qoraallada dheeriga ah ee cookies-ka",
    "description": {
      "uk": {
