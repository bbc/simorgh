...
export const service: DefaultServiceConfig = {
  default: {
    ...
    translations: {
      ...
      accountSignInModal: {
        title: 'माय न्यूज़ में सेव करने के लिए साइन इन करें',
      ...
      myNews: {
        ...
        description: 'मेरे सहेजे गए लेख',
        guestDescription:
          'मेरी ख़बरों में ख़बरें सेव करने के लिए साइन इन करें, और उन्हें अपनी सुविधा से पढ़ें।',
        noArticles: 'आपने अभी तक कोई लेख सहेजा नहीं है',
        errorText:
