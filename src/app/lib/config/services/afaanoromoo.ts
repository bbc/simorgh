  ...
  default: {
    ...
    translations: {
      ...
      sportTeamNames: {
        ...
        austria: 'Ostiriyaa',
        belgium: 'Beeljiyeem',
        'bosnia-herzegovina': 'Bosiniyaafi Herzegovinaa',
        brazil: 'Brazil',
        canada: 'Kaanaadaa',
        'cape-verde': 'Keep Vardii',
        colombia: 'Kolombiyaa',
        croatia: 'Kirooshiyaa',
        curacao: 'Kurasaawoo',
        'czech-republic': 'Ripablika Cheek',
        'dr-congo': 'Ripablika Dimokraatawa Koongoo',
        ecuador: 'Iquwaador',
        egypt: 'Masirii',
        england: 'Ingiliiz',
        france: 'Firaansi',
        ...
        iran: 'Iraan',
        iraq: 'Iraaq',
        'ivory-coast': 'Ivorii Koosti',
        japan: 'Jaappaan',
        jordan: 'Joordaanoos',
        mexico: 'Meksikoo',
        morocco: 'Morookkoo',
        netherlands: 'Nezarlaandis',
        'new-zealand': 'Niiwu Zilaand',
        norway: 'Norwee',
        panama: 'Paanaamaa',
        paraguay: "Paaraagu'aay",
        portugal: 'Portugaal',
        qatar: 'Kaataar',
        'saudi-arabia': 'Saawudi Arabiyaa',
        scotland: 'Iskootilaand',
        senegal: 'Seeneegaal',
        'south-africa': 'Afriikaa Kibbaa',
        'south-korea': 'Koriyaa Kibbaa',
        spain: 'Ispeen',
        sweden: 'Siwiidiin',
        switzerland: 'Siwiitizarlaand',
        tunisia: 'Tuniziyaa',
        turkey: 'Turkii',
        uruguay: 'Yuraagaayi',
        usa: 'USA',
