  ...
  default: {
    ...
    translations: {
      ...
      sport: {
        ...
        onPenalties: 'ပင်နယ်တီဖြင့်',
        onAggregate: 'စုစုပေါင်းရလဒ်ဖြင့်',
        win: 'အနိုင်ရ',
        winOnPenalties: {
          prefix: 'ပင်နယ်တီး',
        ...
        worldCupTeamNames: {
          ...
          austria: 'သြစတီးယား',
          belgium: 'ဘယ်လ်ဂျီယံ',
          'bosnia-herzegovina': 'ဘော့စနီးယား ဟာဇီဂိုးဗီးနား',
          brazil: 'ဘရာဇီး',
          canada: 'ကနေဒါ',
          'cape-verde': 'ကိပ်ဗာ့ဒ်',
          colombia: 'ကိုလံဘီယာ',
          croatia: 'ခရိုအေးရှား',
          curacao: 'ကျူရာဆော်',
          'czech-republic': 'ချက်ပြည်ထောင်စု',
          'dr-congo': 'ကွန်ဂိုသမ္မတနိုင်ငံ',
          ecuador: 'အီကွေဒေါ',
          egypt: 'အီဂျစ်',
          england: 'အင်္ဂလန်',
          france: 'ပြင်သစ်',
