...
const loadableConfig = {
  ...
  afrique: loadable(() => import(/* webpackChunkName: afrique */ './afrique')),
  amharic: loadable(() => import(/* webpackChunkName: amharic */ './amharic')),
  arabic: loadable(() => import(/* webpackChunkName: arabic */ './arabic')),
  archive: loadable(() => import(/* webpackChunkName: archive */ './archive')),
  azeri: loadable(() => import(/* webpackChunkName: azeri */ './azeri')),
  bengali: loadable(() => import(/* webpackChunkName: bengali */ './bengali')),
  burmese: loadable(() => import(/* webpackChunkName: burmese */ './burmese')),
  cymrufyw: loadable(
  ...
  marathi: loadable(() => import(/* webpackChunkName: marathi */ './marathi')),
  ...
  persian: loadable(() => import(/* webpackChunkName: persian */ './persian')),
  pidgin: loadable(() => import(/* webpackChunkName: pidgin */ './pidgin')),
  portuguese: loadable(
    () => import(/* webpackChunkName: portuguese */ './portuguese'),
  ),
  punjabi: loadable(() => import(/* webpackChunkName: punjabi */ './punjabi')),
  russian: loadable(() => import(/* webpackChunkName: russian */ './russian')),
  scotland: loadable(
    () => import(/* webpackChunkName: scotland */ './scotland'),
  ),
  serbian: loadable(() => import(/* webpackChunkName: serbian */ './serbian')),
  sinhala: loadable(() => import(/* webpackChunkName: sinhala */ './sinhala')),
  somali: loadable(() => import(/* webpackChunkName: somali */ './somali')),
  sport: loadable(() => import(/* webpackChunkName: sport */ './sport')),
  swahili: loadable(() => import(/* webpackChunkName: swahili */ './swahili')),
  ...
  ukchina: loadable(() => import(/* webpackChunkName: ukchina */ './ukchina')),
  ukrainian: loadable(
