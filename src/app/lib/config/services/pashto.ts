  ...
  default: {
    ...
    translations: {
      ...
      sport: {
        ...
        onPenalties: 'په پنالټیو کې',
        onAggregate: 'په مجموعي ډول',
        win: 'ګټي',
        winOnPenalties: {
        ...
        worldCupTeamNames: {
          ...
          austria: 'اتريش',
          belgium: 'بلجيم',
          'bosnia-herzegovina': 'بوسنيا هرڅو گووينا',
          brazil: 'برازیل',
          canada: 'کاناډا',
          'cape-verde': 'کيپ وردې',
          colombia: 'کولمبيا',
          croatia: 'کرووېشيا',
          curacao: 'کوراساو',
          'czech-republic': 'د چک جمهوريت',
          'dr-congo': 'د کانگو دېموکراتيک جمهوريت',
          ecuador: 'اېکوادور',
          egypt: 'مصر',
          england: 'انګلستان',
          france: 'فرانسه',
          germany: 'جرمني يا آلمان',
          ghana: 'گانا',
          haiti: 'هايتي يا هيتي',
          iran: 'ايران',
          iraq: 'عراق',
          'ivory-coast': 'د عاج ساحل',
          japan: 'جاپان',
          jordan: 'اردن',
          mexico: 'مکسيکو',
          morocco: 'مراکش يا المغرب',
          netherlands: 'هالنډ',
          'new-zealand': 'نيو زيلاند',
          norway: 'ناروې',
          panama: 'پاناما',
          paraguay: 'پاراگواى',
          portugal: 'پرتگال',
          ...
          scotland: 'سکاټلنډ',
          senegal: 'سېنېگال',
          'south-africa': 'جنوبي ( سويلي ) افريقا',
