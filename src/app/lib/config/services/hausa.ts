  ...
  default: {
    ...
    translations: {
      ...
      sport: {
        ...
        onPenalties: 'ta bugun fanareti',
        onAggregate: 'a haɗin jimla',
        win: 'ya yi nasara',
        winOnPenalties: {
          prefix: 'ta yi nasara',
          suffix: 'a fenariti',
        ...
        worldCupTeamNames: {
          ...
          austria: 'Austria',
          belgium: 'Belgium',
          'bosnia-herzegovina': 'Bornia da Hezegovina',
          brazil: 'Brazil',
          canada: 'Canada',
          ...
          'dr-congo': 'Jamhuriyar Dimokuradiyyar Congo',
          ecuador: 'Ecuador',
          egypt: 'Masar',
          england: 'Ingila',
          france: 'Faransa',
