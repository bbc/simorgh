  ...
  default: {
    ...
    translations: {
      ...
      sport: {
        ...
        onPenalties: 'පෙන්ල්ටි මත',
        onAggregate: 'එකතුවෙන්',
        win: 'ජයගනී',
        winOnPenalties: {
          prefix: 'පෙනල්ටි',
          suffix: 'න් ජය ලබයි',
        ...
        worldCupTeamNames: {
          algeria: 'ඇල්ජීරියා',
          argentina: 'ආජන්ටිනා',
          australia: 'ඕස්ට්‍රේලියා',
          austria: 'ඔස්ට්‍රියා',
          belgium: 'බෙල්ජියම්',
          'bosnia-herzegovina': 'බොස්නියා සහ හර්සගොවිනා',
          brazil: 'බ්රසීලය',
          canada: 'කැනඩා',
          ...
          scotland: 'ස්කොට්ලන්තය',
          senegal: 'සෙනගාලය',
          'south-africa': 'දකුණු අප්‍රිකාව',
