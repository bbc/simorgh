export const latTranslations = {
  ...
  socialEmbed: {
    caption: {
      ...
      articleText: 'Upozorenje: BBC nije odgovoran za sadržaj drugih sajtova.',
      articleAdditionalText: 'Sadržaj %provider_name% može da sadrži reklame.',
    },
    fallback: {
  ...
  include: {
    ...
    linkText: 'Pogledajte punu verziju stranice da biste videli čitav sadržaj.',
  },
...
export const cyrTranslations = {
  ...
  socialEmbed: {
    caption: {
      ...
      articleAdditionalText: 'Садржај %provider_name% може да садржи рекламе.',
    },
    fallback: {
  ...
  include: {
    ...
    linkText: 'Погледајте пуну верзију странице да бисте видели читав садржај.',
  },
