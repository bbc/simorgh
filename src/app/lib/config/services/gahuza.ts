  ...
  default: {
    ...
    translations: {
      ...
      sport: {
        ...
        onPenalties: 'kuri penaliti',
        onAggregate: 'ku giteranyo',
        win: 'itsinda',
        winOnPenalties: {
        ...
        worldCupTeamNames: {
          ...
          austria: 'Austria',
          belgium: 'Ububiligi',
          'bosnia-herzegovina': 'Bosnia na Herzegovina',
          brazil: 'Brasil',
          canada: 'Canada',
          ...
          'dr-congo': 'Republika ya Demokrasi ya Kongo',
          ecuador: 'Ecuador',
          egypt: 'Misiri',
          england: 'Ubwongereza',
          france: 'Ubufaransa',
          ...
          scotland: 'Esikotilande',
          senegal: 'Senegal',
          'south-africa': "Afurika y'epfo",
          'south-korea': 'Republika ya Korea',
          spain: 'Espanye',
          sweden: 'Swede',
          switzerland: 'Ubusuwisi',
          tunisia: 'Tunisia',
          turkey: 'Turkey',
          uruguay: 'Uruguay',
          usa: 'USA',
