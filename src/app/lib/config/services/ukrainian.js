      ...
      cookie: {
        amp: {
          ...
          manage: {
            ...
            description: {
              para1:
                'Ці налаштування стосуються лише сторінок AMP. Вас можуть попросити зазначити свої уподобання ще раз, якщо ви відвідуватимете інші сторінки bbc.com, які не є AMP.',
              para2:
              ...
              para4: {
                text:
                  'Докладніше про необхідну інформацію, яку ми зберігаємо на вашому пристрої, щоб забезпечити роботу наших вебсторінок.',
                url:
              ...
              para7: {
                text:
                  'Докладніше про те, як ми персоналізуємо рекламу на BBC та у наших рекламних партнерів.',
                url:
                  'https://www.bbc.com/usingthebbc/cookies/how-does-the-bbc-use-cookies-for-advertising/',
              },
              para8:
                'Ви можете не отримувати персоналізовану рекламу, натиснувши "Відмовитися від збору даних та продовжити" нижче. Зверніть увагу, що реклама все одно відображатиметься, але вона не буде персоналізованою для вас.',
              para9:
