  ...
  default: {
    ...
    translations: {
      ...
      sport: {
        ...
        versus: 'எதிராக',
        kickOff: 'தொடக்கம்',
        timeToBeConfirmed: 'நேரம் உறுதிப்படுத்தப்படவில்லை',
        teamToBeConfirmed: 'அணி உறுதிப்படுத்தப்படவில்லை',
        afterFullTime: 'முழு நேரத்திற்குப் பிறகு',
        atFullTime: 'முழு நேரத்தில்',
        onPenalties: 'பெனால்டியில்',
        onAggregate: 'மொத்த கணக்கில்',
        win: 'வெற்றி பெறும்',
        winOnPenalties: {
          prefix: 'பெனால்டியில்',
        ...
        worldCupTeamNames: {
          ...
          austria: 'ஆஸ்திரியா',
          belgium: 'பெல்ஜியம்',
          'bosnia-herzegovina': 'போஸ்னியா-ஹெர்சகோவினா',
          brazil: 'பிரேசில்',
          canada: 'கனடா',
          'cape-verde': 'கேப் வர்டி',
          colombia: 'கொலம்பியா',
          croatia: 'குரேஷியா',
          curacao: 'குரசாவ்',
          'czech-republic': 'செக் குடியரசு',
          'dr-congo': 'காங்கோ ஜனநாயக குடியரசு',
          ecuador: 'ஈக்குவடார்',
          egypt: 'எகிப்து',
          england: 'இங்கிலாந்து',
          france: 'பிரான்ஸ்',
