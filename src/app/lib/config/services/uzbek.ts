  ...
  translations: {
    ...
    sport: {
      ...
      worldCupTeamNames: {
        ...
        austria: 'Австрия',
        belgium: 'Бельгия',
        'bosnia-herzegovina': 'Босния ва Герцеговина',
        brazil: 'Бразилия',
        canada: 'Канада',
        ...
        croatia: 'Хорватия',
        curacao: 'Кюрасао',
        'czech-republic': 'Чехия Республикаси',
        'dr-congo': 'Конго Демократик Республикаси',
        ecuador: 'Эквадор',
        egypt: 'Миср',
        england: 'Англия',
        france: 'Франция',
        ...
        iran: 'Эрон',
        iraq: 'Ироқ',
        'ivory-coast': 'Кот-д’Ивуар Республикаси',
        japan: 'Япония',
        jordan: 'Иордания',
        mexico: 'Мексика',
        morocco: 'Марокаш',
        netherlands: 'Нидерландия',
        'new-zealand': 'Янги Зеландия',
        norway: 'Норвегия',
        panama: 'Панама',
        paraguay: 'Парагвай',
        portugal: 'Португалия',
        qatar: 'Қатар',
        'saudi-arabia': 'Саудия Арабистони',
        scotland: 'Шотландия',
        senegal: 'Сенегал',
        'south-africa': 'ЖАР',
        'south-korea': 'Жанубий Корея',
        spain: 'Испания',
        sweden: 'Швеция',
  ...
  lat: {
    ...
    translations: {
      ...
      liteSite: {
        ...
        informationPage: 'Internet tejamkor ushbu versiya haqida batafsil ma’lumot',
        informationPageLink:
          'https://www.bbc.com/uzbek/articles/crel1q4jrz9o/lat',
        dataSaving: 'Faqat matnli versiya',
        articleDataSavingLinkText:
          'Faqat matnli versiya',
      },
      mediaAssetPage: {
      ...
      sport: {
        ...
        worldCupTeamNames: {
          ...
          'dr-congo': 'Kongo Demokratik Respublikasi',
          ecuador: 'Ekvador',
          egypt: 'Misr',
          england: 'Angliya',
          france: 'Fransiya',
          ...
          iran: 'Eron',
          iraq: 'Iroq',
          'ivory-coast': 'Kot-d’Ivuar Respublikasi',
          japan: 'Yaponiya',
          jordan: 'Iordaniya',
          mexico: 'Meksika',
          morocco: 'Marokash',
