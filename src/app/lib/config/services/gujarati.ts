  ...
  default: {
    ...
    translations: {
      ...
      sport: {
        ...
        versus: 'સામે',
        kickOff: 'શરૂઆત',
        timeToBeConfirmed: 'સમયની પુષ્ટિ થવાની છે',
        teamToBeConfirmed: 'ટીમની પુષ્ટિ કરવી બાકી',
        afterFullTime: 'સંપૂર્ણ સમય બાદ',
        atFullTime: 'સંપૂર્ણ સમયમાં',
        onPenalties: 'પેનલ્ટીમાં',
        onAggregate: 'કુલ ગણતરીમાં',
        win: 'જીતે છે',
        winOnPenalties: {
          prefix: 'પેનલ્ટીમાં',
          suffix: 'જીતે છે',
        ...
        worldCupTeamNames: {
          ...
          austria: 'ઑસ્ટ્રિયા',
          belgium: 'બેલ્જિયમ',
          'bosnia-herzegovina': 'બોસ્નિઆ અને હર્જેગોવિના',
          brazil: 'બ્રાઝિલ',
          canada: 'કૅનેડા',
          ...
          'dr-congo': 'ડેમૉક્રૅટિક રિપબ્લિક કોંગો',
          ecuador: 'ઇક્વાડોર',
          egypt: 'ઇજિપ્ત',
          england: 'ઇંગ્લેન્ડ',
          france: 'ફ્રાન્સ',
