  ...
  default: {
    ...
    translations: {
      ...
      sport: {
        ...
        versus: 'বনাম',
        kickOff: 'কিক-অফ',
        timeToBeConfirmed: 'সময় নিশ্চিত করা হবে',
        teamToBeConfirmed: 'দল নিশ্চিত করা হবে',
        afterFullTime: 'পূর্ণ সময়ের পরে',
        atFullTime: 'পূর্ণ সময়ে',
        onPenalties: 'পেনাল্টিতে',
        onAggregate: 'মোট হিসাবে',
        win: 'জয় লাভ করে',
        winOnPenalties: {
          prefix: 'পেনাল্টিতে',
        ...
        worldCupTeamNames: {
          ...
          austria: 'অস্ট্রিয়া',
          belgium: 'বেলজিয়াম',
          'bosnia-herzegovina': 'বসনিয়া ও হার্জেগোভিনা',
          brazil: 'ব্রাজিল',
          canada: 'কানাডা',
