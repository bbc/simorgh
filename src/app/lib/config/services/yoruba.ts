  ...
  default: {
    ...
    translations: {
      ...
      sport: {
        ...
        onPenalties: 'lori pẹ́nàlítì',
        onAggregate: 'lori apapọ',
        win: 'ṣẹ́gun',
        winOnPenalties: {
          prefix: 'ṣẹ́gun',
          suffix: 'ní penariti',
        ...
        worldCupTeamNames: {
          ...
          australia: 'Ilẹ Australia',
          austria: 'Orilẹede Austria',
          belgium: 'Orilẹede Belgium',
          'bosnia-herzegovina': 'Orilẹede Bosnia ati Herzegovnia',
          brazil: 'Ilu Brasil',
          canada: 'Orilẹede Canada',
          'cape-verde': 'Erekusu Cape Verde',
          colombia: 'Orilẹede Colombia',
          croatia: 'Orilẹede Croatia',
          curacao: 'Kúrásáò',
          'czech-republic': 'Orilẹede Chech',
          'dr-congo': 'Orilẹede Congo',
          ecuador: 'Orilẹede Ecuador',
          egypt: 'Orilẹede Egypt',
          england: 'Ilẹ̀ Gẹ̀ẹ́sì',
          france: 'Orilẹede France',
          germany: 'Orilẹede Germany',
          ...
          mexico: 'Orilẹede Mexico',
          morocco: 'Orilẹede Morrocco',
          netherlands: 'Orilẹede Netherlands',
          'new-zealand': 'Orilẹede New Zealand',
          norway: 'Orilẹede Norway',
          panama: 'Orilẹede Panama',
          paraguay: 'Orilẹede Paraguay',
          portugal: 'Orilẹede Portugal',
          qatar: 'Orilẹede Quatar',
          'saudi-arabia': 'Orilẹede Saudi Arabia',
          scotland: 'Skọ́tìlándì',
          senegal: 'Orilẹede Senegal',
          'south-africa': 'Orilẹede South Africa',
          'south-korea': 'Orilẹede South Korea',
          spain: 'Orilẹede Spain',
          sweden: 'Orilẹede Sweden',
          switzerland: 'Orilẹede Switzerland',
          tunisia: 'Orilẹede Tunisia',
          turkey: 'Orilẹede Turkey',
