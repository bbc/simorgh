    ...
    translations: {
      ...
      sport: {
        ...
        worldCupTeamNames: {
          ...
          austria: 'ਆਸਟਰੀਆ',
          belgium: 'ਬੈਲਜੀਅਮ',
          'bosnia-herzegovina': 'ਬੋਸਨੀਆ ਅਤੇ ਹੇਰਜ਼ੇਗੋਵਨੀਆ',
          brazil: 'ਬ੍ਰਾਜ਼ੀਲ',
          canada: 'ਕੈਨੇਡਾ',
          'cape-verde': 'ਕੇਪ ਵਰਦੇ',
          colombia: 'ਕੋਲੰਬੀਆ',
          croatia: 'ਕਰੋਸ਼ੀਆ',
          curacao: 'ਕੁਰਾਸਾਓ',
          'czech-republic': 'ਚੈਕ ਗਣਰਾਜ',
          'dr-congo': 'ਲੋਕਤੰਤਰੀ ਗਣਰਾਜ ਕੌਂਗੋ',
          ecuador: 'ਇਕੁਏਡੋਰ',
          egypt: 'ਮਿਸਰ',
          england: 'ਇੰਗਲੈਂਡ',
          france: 'ਫਰਾਂਸ',
          ...
          iran: 'ਇਰਾਨ',
          iraq: 'ਇਰਾਕ',
          'ivory-coast': 'ਆਇਵਰੀ ਕੋਸਟ',
          japan: 'ਜਪਾਨ',
          jordan: 'ਜੋਰਡਨ',
          mexico: 'ਮੈਕਸੀਕੋ',
          morocco: 'ਮੁਰੱਕੋ',
          netherlands: 'ਨੀਦਰਲੈਂਡਜ਼',
