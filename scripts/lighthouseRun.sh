...
lighthouse http://localhost:7080/hindi \
  ...
  --config-path scripts/lighthouseConfig.js && \
  node scripts/lighthouseBudget.js run lighthouse-reports/hindi-home.report.json
...
lighthouse http://localhost:7081/pidgin/live/c7p765ynk9qt \
  ...
  --config-path scripts/lighthouseConfig.js && \
  node scripts/lighthouseBudget.js run lighthouse-reports/pidgin-live.report.json
...
lighthouse http://localhost:7081/somali/send/u130092370 \
  ...
  --config-path scripts/lighthouseConfig.js && \
  node scripts/lighthouseBudget.js run lighthouse-reports/somali-send.report.json