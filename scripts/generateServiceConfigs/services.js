// This file configures which services are generated by this script
// It also allows some per-service configuration
// See README.md for full documentation
const services = {
    // 'afrique' will be the serviceName - this key is used to determine:
    //   - which YAML file to load
    //   - the value of the 'serviceName' key in the output
    //   - the file name of the resulting JS file
    afrique: {
        // The name of the ini file to load, excluding the extension
        iniName: 'fr'
    },
    afaanoromoo: {
      iniName: 'om',
      // Overrides allow specific keys to be overridden during config generation for this service
      // This will override the key in both the YAML and INI file
      overrides: {
    ...
    burmese: {
      iniName: 'my',
      // Some YAML files have issues.  If a yamlCleaner is provided for a service,
      // it will be given the raw YAML content, and the return value of the function
      // will be used as the YAML instead
