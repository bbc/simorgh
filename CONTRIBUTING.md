...
Once you find an issue you would like to work on, please see this [guide about our project board workflow](https://github.com/bbc/simorgh/blob/latest/docs/Project-Board-Guide./README.md)
...
> We recommend you have a valid GPG key set up in GitHub. **All commits should be GPG signed** We have a very small [guide](docs/GPG-Signing-Guide./README.md) for setting up GPG signing on macOS.
