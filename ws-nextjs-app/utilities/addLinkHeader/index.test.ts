...
describe('addLinkHeader', () => {
  ...
  it('should add the correct Link header for Live env', () => {
    ...
    process.env.SIMORGH_ATI_BASE_URL = 'https://a1.api.bbc.co.uk/hit.xiti?';

    addLinkHeader({ ctx: mockCtx });

    expect(mockSetHeader).toHaveBeenCalledWith(
      'Link',
      '<https://ichef.bbci.co.uk>; rel="dns-prefetch", <https://ichef.bbci.co.uk>; rel="preconnect",<https://static.files.bbci.co.uk>; rel="dns-prefetch", <https://static.files.bbci.co.uk>; rel="preconnect",<https://static.files.bbci.co.uk>; rel="preconnect"; crossorigin,<https://a1.api.bbc.co.uk/hit.xiti?>; rel="dns-prefetch", <https://a1.api.bbc.co.uk/hit.xiti?>; rel="preconnect",<https://ping.chartbeat.net>; rel="dns-prefetch", <https://ping.chartbeat.net>; rel="preconnect"',
    );
  });
});
