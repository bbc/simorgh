...
describe('shouldServeRelaxedCsp', () => {
  ...
  it('returns "relaxed" Csp when toggle is enabled but does not have values set', async () => {
    const ctx = createDocumentContext('/pidgin/live/c7p765ynk9qt');
  ...
  it('returns "relaxed" Csp when country is not in omittedCountries', async () => {
  ...
  it('returns "full" CSP when toggle is enabled and given country is in omittedCountries', async () => {
  ...
  it('returns "full" CSP when adsNonce.enabled is false', async () => {
    const ctx = createDocumentContext('/pidgin/live/c7p765ynk9qt', 'gb');
