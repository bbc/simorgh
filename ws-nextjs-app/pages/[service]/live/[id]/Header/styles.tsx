...
export default {
  ...
  sportTitleRow: ({ mq, spacings }: Theme) =>
    css({
      ...
      // Divider spans the viewport width minus a 24px gutter each side, matching
      // the scores section below. Centred on the row, which is viewport-width
      // until contentContainer caps and centres itself, so it holds at every breakpoint.
      '&::after': {
        content: '""',
        position: 'absolute',
        insetBlockEnd: 0,
