  ...
  return (
    <div {...viewTracker} data-e2e="share">
      <button
        ...
        ref={focusRef}
        onClick={handleShare}
        className="inline-flex items-center text-black text-pica font-sansBold p-2.5 mt-4 mb-12 ml-8 border-2 border-black bg-transparent cursor-pointer hover:text-white hover:border-brand-background hover:bg-brand-background focus-visible:text-white focus-visible:border-brand-background focus-visible:bg-brand-background"
      >
        <ShareSvg />
        <span role="text">
