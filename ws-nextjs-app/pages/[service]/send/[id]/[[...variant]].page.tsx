...
const fetchData = () => ({
  data: {
    ...
    settings: {
      ...
      brand: 'BBC Mundo',
      brandId: 'ws-mundo',
      replyEmailAddress: 'BBCMundoEscribanos2@bbc.co.uk',
      ageGroup: [],
      exifMetadataEnabled: false,
      ppGroupId: 'e24ff05b-d0f4-4e26-ab6d-ba5e9291d97a',
      pageBackgroundTemplateUrl:
        'https://ichef.bbci.co.uk/images/ic/$recipe/p08tcz26.png',
      brandLogo: '',
