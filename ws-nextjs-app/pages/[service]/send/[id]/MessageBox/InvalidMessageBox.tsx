...
const ErrorSymbol = () => (
  <svg
    ...
    focusable="false"
    aria-hidden="true"
    className="fill-white align-middle mr-3 min-w-[1.5rem]"
  >
...
const InvalidMessageBox = forwardRef(
  (
    ...
    return (
      <>
        {hasArrowStyle && <div className="bg-error-core clip-path-triangle w-8 h-3 ml-8 mt-4" />}
        <div
          className={`bg-error-core outline-1 outline-transparent p-3 ${
            !hasArrowStyle ? 'my-4' : ''
          } ${
            isErrorSummary ? 'focus:outline-black focus:shadow-[0_0_0_0.25rem_white] focus:outline-offset-1' : ''
          }`}
