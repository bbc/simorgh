                    ...
                    <div className="column-clearfix">
                        <div className="column--primary">
                            ...
                            <p className="language-switcher">
                                <a className="switcher" id="switcher" href="#" onClick={languageToggle}><span className="toggle">Switch list to English</span><span className="toggle hide">Switch list to localised scripts</span></a>
                            </p>
                            <div id="localised_version" className="panel">
                                <div className="group-title-component">
                                    ...
                                    <ul className="units-list">
                                        <li id="afaanoromoo" className="unit"><a href="https://www.bbc.com/afaanoromoo">Oduu Afaan Oromootiin</a></li>
                                        <li id="amharic" className="unit"><a href="https://www.bbc.com/amharic">ዜና በአማርኛ</a></li>
                                        <li id="afrique" className="unit"><a href="https://www.bbc.com/afrique">L'actualité en Français</a></li>
                                        <li id="hausa" className="unit"><a href="https://www.bbc.com/hausa">Labarai da Hausa</a></li>
                                        <li id="igbo" className="unit"><a href="https://www.bbc.com/igbo">Akụkọ n’Igbo</a></li>
                                        <li id="kirundi" className="unit"><a href="https://www.bbc.com/gahuza">Amakuru mu Kinyarwanda/ Kirundi</a></li>
                                        <li id="pidgin" className="unit"><a href="https://www.bbc.com/pidgin">News in Pidgin</a></li>
                                        <li id="somali" className="unit"><a href="https://www.bbc.com/somali">War Af Soomaali ah</a></li>
                                        <li id="swahili" className="unit"><a href="https://www.bbc.com/swahili">Habari kwa Kiswahili</a></li>
                                        <li id="tigrinya" className="unit"><a href="https://www.bbc.com/tigrinya">ዜና ብትግርኛ</a></li>
                                        <li id="yoruba" className="unit"><a href="https://www.bbc.com/yoruba">Ìròyìn ní Yorùbá</a></li>
                                    </ul>
                                </div>
                                <div className="group-title-component">
                                    <h2 className="group__title">
                                    ...
                                    <ul className="units-list">
                                        <li id="kyrgyz" className="unit"><a href="https://www.bbc.com/kyrgyz">Кыргыз тилиндеги жаңылыктар</a></li>
                                        <li id="uzbek" className="unit"><a href="https://www.bbc.com/uzbek">Ўзбек тилидаги янгиликлар</a></li>
                                    </ul>
                                </div>
                                <div className="group-title-component">
                                    <h2 className="group__title">
                                    ...
                                    <ul className="units-list">
                                        <li id="burmese" className="unit"><a href="https://www.bbc.com/burmese">မြန်မာသတင်းများ</a></li>
                                        <li id="chinese" className="unit"><a href="https://www.bbc.com/zhongwen/simp">中文新闻</a></li>
                                        <li id="indonesia" className="unit"><a href="https://www.bbc.com/indonesia">Berita Indonesia</a></li>
                                        <li id="japanese" className="unit"><a href="https://www.bbc.com/japanese">日本語ニュース</a></li>
                                        <li id="korean" className="unit"><a href="https://www.bbc.com/korean">한국어</a></li>
                                        <li id="thai" className="unit"><a href="https://www.bbc.com/thai">ข่าวภาษาไทย</a></li>
                                        <li id="vietnamese" className="unit"><a href="https://www.bbc.com/vietnamese">Tin Tiếng Việt</a></li>
                                    </ul>
                                </div>
                                <div className="group-title-component">
                                    <h2 className="group__title">
                                    ...
                                    <ul className="units-list">
                                        <li id="bengali" className="unit"><a href="https://www.bbc.com/bengali">বাংলা খবর</a></li>
                                        <li id="gujarati" className="unit"><a href="https://www.bbc.com/gujarati">ગુજરાતીમાં સમાચાર</a></li>
                                        <li id="hindi" className="unit"><a href="https://www.bbc.com/hindi">हिन्दी समाचार</a></li>
                                        <li id="marathi" className="unit"><a href="https://www.bbc.com/marathi">मराठीत बातम्या</a></li>
                                        <li id="nepali" className="unit"><a href="https://www.bbc.com/nepali">नेपाली समाचार</a></li>
                                        <li id="pashto" className="unit pashto_font"><a href="https://www.bbc.com/pashto">پښتو نړیوال خپرونه</a></li>
                                        <li id="punjabi" className="unit"><a href="https://www.bbc.com/punjabi">ਪੰਜਾਬੀ ਖ਼ਬਰਾਂ</a></li>
                                        <li id="sinhala" className="unit"><a href="https://www.bbc.com/sinhala">සිංහල පුවත්</a></li>
                                        <li id="tamil" className="unit"><a href="https://www.bbc.com/tamil">தமிழில் செய்திகள்</a></li>
                                        <li id="telugu" className="unit"><a href="https://www.bbc.com/telugu">తెలుగు వార్తలు</a></li>
                                        <li id="urdu" className="urdu_font unit"><a href="https://www.bbc.com/urdu">اردو میں خبریں</a></li>
                                    </ul>
                                </div>
                                <div className="group-title-component">
                                    <h2 className="group__title">
                                    ...
                                    <ul className="units-list">
                                        <li id="azeri" className="unit"><a href="https://www.bbc.com/azeri">Azərbaycanca xəbərlər</a></li>
                                        <li id="english" className="unit"><a href="https://www.bbc.co.uk/news">News in English</a></li>
                                        <li id="gaelic" className="unit"><a href="https://www.bbc.co.uk/naidheachdan">Naidheachdan</a></li>
                                        <li id="russian" className="unit"><a href="https://www.bbc.com/russian">Новости на русском языке</a></li>
                                        <li id="serbian" className="unit"><a href="https://www.bbc.com/serbian">BBC News na srpskom</a></li>
                                        <li id="turkish" className="unit"><a href="https://www.bbc.com/turkce">Türkçe Haberler</a></li>
                                        <li id="ukrainian" className="unit"><a href="https://www.bbc.com/ukrainian">Новини українською мовою</a></li>
                                        <li id="cymrufyw" className="unit"><a href="https://www.bbc.co.uk/cymrufyw">Newyddion</a></li>
                                    </ul>
                                </div>
                                <div className="group-title-component">
                                    <h2 className="group__title">
                                    ...
                                    <ul className="units-list">
                                        <li id="brasil" className="unit"><a href="https://www.bbc.com/portuguese">Notícias em Português</a></li>
                                        <li id="mundo" className="unit"><a href="https://www.bbc.com/mundo">Noticias para hispanoparlantes</a></li>
                                    </ul>
                                </div>
                                <div className="group-title-component">
                                    <h2 className="group__title">
                                    ...
                                    <ul className="units-list">
                                        <li id="arabic" className="arabic_font unit"><a href="http://www.bbc.com/arabic">أخبار باللغة العربية</a></li>
                                        <li id="persian" className="persian_font unit"><a href="http://www.bbc.com/persian">خبرها به فارسی</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div id="english_version" className="panel hide">
                                <div className="group-title-component">
                                    ...
                                    <ul className="units-list">
                                        <li id="afaanoromoo" className="unit"><a href="https://www.bbc.com/afaanoromoo">Afaan Oromoo</a></li>
                                        <li id="amharic" className="unit"><a href="https://www.bbc.com/amharic">Amharic</a></li>
                                        <li id="afrique" className="unit"><a href="https://www.bbc.com/afrique">French</a></li>
                                        <li id="hausa" className="unit"><a href="https://www.bbc.com/hausa">Hausa</a></li>
                                        <li id="igbo" className="unit"><a href="https://www.bbc.com/igbo">Igbo</a></li>
                                        <li id="kirundi" className="unit"><a href="https://www.bbc.com/gahuza">Kirundi</a></li>
                                        <li id="pidgin" className="unit"><a href="https://www.bbc.com/pidgin">Pidgin</a></li>
                                        <li id="somali" className="unit"><a href="https://www.bbc.com/somali">Somali</a></li>
                                        <li id="swahili" className="unit"><a href="https://www.bbc.com/swahili">Swahili</a></li>
                                        <li id="tigrinya" className="unit"><a href="https://www.bbc.com/tigrinya">Tigrinya</a></li>
                                        <li id="yoruba" className="unit"><a href="https://www.bbc.com/yoruba">Yoruba</a></li>
                                    </ul>
                                </div>
                                <div className="group-title-component">
                                    <h2 className="group__title">
                                    ...
                                    <ul className="units-list">
                                        <li id="kyrgyz" className="unit"><a href="https://www.bbc.com/kyrgyz">Kyrgyz</a></li>
                                        <li id="uzbek" className="unit"><a href="https://www.bbc.com/uzbek">Uzbek</a></li>
                                    </ul>
                                </div>
                                <div className="group-title-component">
                                    <h2 className="group__title">
                                    ...
                                    <ul className="units-list">
                                        <li id="burmese" className="unit"><a href="https://www.bbc.com/burmese">Burmese</a></li>
                                        <li id="chinese" className="unit"><a href="https://www.bbc.com/zhongwen/simp">Chinese</a></li>
                                        <li id="indonesia" className="unit"><a href="https://www.bbc.com/indonesia">Indonesian</a></li>
                                        <li id="japanese" className="unit"><a href="https://www.bbc.com/japanese">Japanese</a></li>
                                        <li id="korean" className="unit"><a href="https://www.bbc.com/korean">Korean</a></li>
                                        <li id="thai" className="unit"><a href="https://www.bbc.com/thai">Thai</a></li>
                                        <li id="vietnamese" className="unit"><a href="https://www.bbc.com/vietnamese">Vietnamese</a></li>
                                    </ul>
                                </div>
                                <div className="group-title-component">
                                    <h2 className="group__title">
                                    ...
                                    <ul className="units-list">
                                        <li id="bengali" className="unit"><a href="https://www.bbc.com/bengali">Bengali</a></li>
                                        <li id="gujarati" className="unit"><a href="https://www.bbc.com/gujarati">Gujarati</a></li>
                                        <li id="hindi" className="unit"><a href="https://www.bbc.com/hindi">Hindi</a></li>
                                        <li id="marathi" className="unit"><a href="https://www.bbc.com/marathi">Marathi</a></li>
                                        <li id="nepali" className="unit"><a href="https://www.bbc.com/nepali">Nepali</a></li>
                                        <li id="pashto" className="unit"><a href="https://www.bbc.com/pashto">Pashto</a></li>
                                        <li id="punjabi" className="unit"><a href="https://www.bbc.com/punjabi">Punjabiਂ</a></li>
                                        <li id="sinhala" className="unit"><a href="https://www.bbc.com/sinhala">Sinhala</a></li>
                                        <li id="tamil" className="unit"><a href="https://www.bbc.com/tamil">Tamil</a></li>
                                        <li id="telugu" className="unit"><a href="https://www.bbc.com/telugu">Telugu</a></li>
                                        <li id="urdu" className="unit"><a href="https://www.bbc.com/urdu">Urdu</a></li>
                                    </ul>
                                </div>
                                <div className="group-title-component">
                                    <h2 className="group__title">
                                    ...
                                    <ul className="units-list">
                                        <li id="azeri" className="unit"><a href="https://www.bbc.com/azeri">Azeri</a></li>
                                        <li id="english" className="unit"><a href="https://www.bbc.co.uk/news">English</a></li>
                                        <li id="gaelic" className="unit"><a href="https://www.bbc.co.uk/naidheachdan">Gaelic</a></li>
                                        <li id="russian" className="unit"><a href="https://www.bbc.com/russian">Russian</a></li>
                                        <li id="serbian" className="unit"><a href="https://www.bbc.com/serbian">Serbian</a></li>
                                        <li id="turkish" className="unit"><a href="https://www.bbc.com/turkce">Turkish</a></li>
                                        <li id="ukrainian" className="unit"><a href="https://www.bbc.com/ukrainian">Ukrainian</a></li>
                                        <li id="welsh" className="unit"><a href="https://www.bbc.co.uk/cymrufyw">Welsh</a></li>
                                    </ul>
                                </div>
                                <div className="group-title-component">
                                    <h2 className="group__title">
                                    ...
                                    <ul className="units-list">
                                        <li id="brasil" className="unit"><a href="https://www.bbc.com/portuguese">Portuguese</a></li>
                                        <li id="mundo" className="unit"><a href="https://www.bbc.com/mundo">Spanish</a></li>
                                    </ul>
                                </div>
                                <div className="group-title-component">
                                    <h2 className="group__title">
                                    ...
                                    <ul className="units-list">
                                        <li id="arabic" className="unit"><a href="http://www.bbc.com/arabic">Arabic</a></li>
                                        <li id="persian" className="unit"><a href="http://www.bbc.com/persian">Persian</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
