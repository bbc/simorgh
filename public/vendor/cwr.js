      ...
      238: function (e, t, n) {
        ...
        !(function (o, i) {
          ...
          var s = 'function',
            ...
            T = {
              browser: [
                ...
                [d, [h, C.str, x.browser.oldSafari.version]],
                [/(webkit|khtml)\/([\w\.]+)/i],
                [d, h],
              ...
              os: [
                ...
                [d, [h, C.str, x.os.windows.version]],
                [/(win(?=3|9|n)|win\s9x\s)([nt\d\.]+)/i],
                [
                  [d, 'Windows'],
                  [h, C.str, x.os.windows.version],
                ],
                [
            ...
            A = function (e, t) {
              ...
              var n =
                  e ||
                  (void 0 !== o && o.navigator && o.navigator.userAgent
              ...
              return (
                (this.getBrowser = function () {
                  ...
                  return (
                    C.rgx.call(e, n, r.browser),
                    (e.major = E.major(e.version)),
                    e
                  );
                }),
                ...
                (this.setUA = function (e) {
                  return (
                    (n = typeof e === u && e.length > 255 ? E.trim(e, 255) : e),
                    this
                  );
                }),
                this.setUA(n),
          ...
          (A.VERSION = '0.7.28'),
            ...
            typeof t !== a
              ? (e.exports && (t = e.exports = A), (t.UAParser = A))
              : (r = function () {
                  return A;
  ...
  (n.d = function (e, t) {
    ...
    (function () {
      ...
      function f(e) {
        ...
        try {
          for (
            var o = u(Object.keys(e).sort()), i = o.next();
            !i.done;
            i = o.next()
          ) {
            var s = i.value,
            ...
            if (((s = l(s)), Array.isArray(a)))
              ...
              var f = s;
              (a || 'string' == typeof a) && (f += '=' + l(a)), r.push(f);
            }
          }
        } catch (e) {
          t = {
      ...
      for (
        var p = (function () {
            ...
            return (
              ...
              (t.prototype.handle = function (t, n) {
                  ...
                  y = [
                    ...
                    new Promise(function (e, t) {
                      h &&
                        setTimeout(function () {
                          var e = new Error(
                            'Request did not complete within ' + h + ' ms',
                          );
      ...
      for (
        y = 0, g = 'a'.charCodeAt(0), m = 'z'.charCodeAt(0);
        y + g <= m;
        y++
      ) {
      ...
      var S = function () {
                  ...
                  return O(this, function (t) {
                    return [
                      ...
                      new Promise(function (t, n) {
                        ...
                        if (
                          ((r.expiration = new Date(r.expiration)),
                          (e.credentials = r),
                          e.renewCredentials())
                        )
                          return n();
                  ...
                  return L(this, function (t) {
                    ...
                    return (
                      ...
                      [
                        2,
                        (function () {
                          return n.client.getCredentialsForIdentity(
                            n.identityPoolId,
                          );
                        })().then(function (t) {
                          e.credentials = t;
        ...
        j = (function () {
          function e(e) {
            (this.plugins = new Map()), (this.context = e);
          }
          return (
            (e.prototype.addPlugin = function (e) {
              var t = e.getPluginId();
              if (!t) throw new Error('InvalidPluginIdException');
        ...
        z = (function () {
          ...
          return (
            (e.prototype.load = function (e) {
              (this.recordEvent = e.record), this.enable();
            }),
            (e.prototype.enable = function () {
            ...
            (e.prototype.addEventHandler = function (e) {
              ...
              (this.eventListenerMap.set(e, r), e.cssLocator)
                ? document.querySelectorAll(e.cssLocator).forEach(function (e) {
                    e.addEventListener(n, r);
                  })
                : e.elementId
                ? null === (t = document.getElementById(e.elementId)) ||
                  void 0 === t ||
                  t.addEventListener(n, r)
                : e.element && e.element.addEventListener(n, r);
            }),
      ...
      var F,
        ...
        V = function (e, t) {
          ...
          return (
            !(function (e) {
              ...
              ? W(r) &&
                (function (e, t) {
                  (e.type = t.toString()), (e.message = t.toString());
                })(n, r)
              : (function (e, t, n) {
        ...
        Z = (function () {
          ...
          return (
            (e.prototype.load = function (e) {
              (this.recordEvent = e.record), this.addEventHandler();
            }),
            (e.prototype.enable = function () {
        ...
        J = function (e, t, n, r, o) {
          ...
          (i += t || ''),
            void 0 !== o
              ...
              : void 0 !== r && (i += '; Expires=' + Y(r).toUTCString()),
            (i += '; Domain=' + n.domain),
            (i += '; Path=' + n.path),
      ...
      var ie = function (e) {
        ...
        if (!ne(n)) throw TypeError('Stringified UUID is invalid');
        return n;
      };
      for (
          ...
          le = (function () {
            ...
            return (
              (e.prototype.getSession = function () {
                return (
                  this.session.sessionId === ce || this.useCookies()
                    ? ((this.session.sessionId === ce && this.useCookies()) ||
              ...
              (e.prototype.createSession = function () {
                (this.session = {
                  ...
                  (this.sessionExpiry = new Date(
                    new Date().getTime() +
                      1e3 * this.config.sessionLengthSeconds,
                  )),
              ...
              (e.prototype.sessionCookieName = function () {
                return this.config.cookieAttributes.unique
                  ? 'cwr_s_' + this.appMonitorDetails.id
                  : A;
              }),
              e
            );
            ...
            return (
              ...
              (e.prototype.recordPageView = function (e) {
                if (
                  ...
                  !this.page && this.resumed)
                )
                  this.createResumedPage(e);
                else if (this.page) {
                  if (this.page.pageId === e) return;
                  this.createNextPage(e);
                } else this.createLandingPage(e);
                this.collectAttributes(), this.recordPageViewEvent();
              }),
              ...
              (e.prototype.createPageViewEvent = function () {
                ...
                return (
                  this.recordInteraction &&
                    ((e.interaction = this.page.interaction),
                    (e.pageInteractionId =
                      this.page.pageId + '-' + this.page.interaction),
                    void 0 !== this.page.parentPageId &&
                      (e.parentPageInteractionId =
                        this.page.parentPageId +
                        '-' +
                        (this.page.interaction - 1))),
                  e
                );
              }),
            ...
            function e(e, t) {
              ...
              (this.events = []),
                ...
                (this.recordSessionInitEvent = function (e, t, r) {
                  n.enabled &&
                    (n.sessionManager.incrementSessionEventCount(),
                    n.canRecord(e) && n.addRecordToCache(t, r));
                }),
                (this.canRecord = function (e) {
                  return (
                    e.record &&
                    (e.eventCount <= n.config.sessionEventLimit ||
                      n.config.sessionEventLimit <= 0)
                  );
                }),
                (this.addRecordToCache = function (e, t) {
                  if (n.enabled) {
                    n.events.length === n.config.eventCacheSize &&
                      n.events.shift();
                    var r = fe(
                      fe(
                        {
                        ...
                        n.sessionManager.getAttributes(),
                      ),
                      n.pageManager.getAttributes(),
                    );
                    n.events.push({
              ...
              (e.prototype.isCurrentUrlAllowed = function () {
                ...
                return (
                  !(
                    ...
                    this.config.pagesToExclude.some(function (t) {
                      return t.test(e);
                    })
                  ) &&
                  (!(
        ...
        1 === ge.length && (ge = '0' + ge), (he[ye] = ge), (ve[ge] = ye);
      }
      function me(e) {
        for (var t = '', n = 0; n < e.byteLength; n++) t += he[e[n]];
        return t;
      }
      var we = function () {
        return (
      ...
      var xe,
        ...
        We = function (e, t, n) {
          ...
          try {
            for (
              var a = Ee(Object.keys(i).sort()), c = a.next();
              !c.done;
              c = a.next()
            ) {
              var u = c.value,
            ...
            return Se(this, function (l) {
              switch (l.label) {
                case 0:
                  try {
                    for (
                      e = Ee(Object.keys(n)), o = e.next();
                      !o.done;
                      o = e.next()
                    )
                      if ((i = o.value).toLowerCase() === Le) return [2, n[i]];
                  } catch (e) {
                    c = {
                      error: e,
                    };
                ...
                case 1:
                  return 'string' == typeof r ||
                    ...
                    ? ((s = new t()).update(r), (a = me), [4, s.digest()])
                    : [3, 3];
                case 2:
        ...
        Ke = function (e) {
          ...
          try {
            for (
              var r = Ee(Object.keys(e.headers)), o = r.next();
              !o.done;
              o = r.next()
            ) {
              var i = o.value;
                      ...
                      case 4:
                        return (
                          ...
                          i > 604800
                            ...
                            : ((g = Ue(y, f, null != l ? l : this.service)),
                              (m = (function (e, t) {
                                var n, r, o;
                                void 0 === t && (t = {});
                                var i =
                                ...
                                try {
                                  for (
                                    var u = Ee(Object.keys(s)), l = u.next();
                                    !l.done;
                                    l = u.next()
                                  ) {
                                    var d = l.value,
                              ...
                              d.sessionToken && (m.query[Ie] = d.sessionToken),
                              (m.query['X-Amz-Algorithm'] = Me),
                              (m.query['X-Amz-Credential'] =
                                d.accessKeyId + '/' + g),
                              (m.query['X-Amz-Date'] = v),
                              (m.query['X-Amz-Expires'] = i.toString(10)),
                              (w = We(m, s, c)),
                              (m.query['X-Amz-SignedHeaders'] = $e(w)),
                              (b = m.query),
                              (S = Ae),
                              (E = this.getSignature),
                              (C = [v, g, this.getSigningKey(d, f, y, l)]),
                              (x = this.createCanonicalRequest),
                              (T = [m, w]),
                              [4, Ve(e, this.sha256)])
                        );
                      case 5:
                        return [
                          ...
                          E.apply(
                            this,
                            C.concat([x.apply(this, T.concat([A.sent()]))]),
                          ),
                        ];
                      case 6:
                  ...
                  switch (g.label) {
                    ...
                    case 3:
                      return (
                        ...
                        (u = o.shortDate),
                        (l = o.longDate),
                        (d = Ue(u, e, null != c ? c : this.service)),
                        [
                          4,
                          Ve(
                            {
                  ...
                  switch (f.label) {
                    ...
                    case 4:
                      return (
                        (n = r),
                        (a = Ye(o).shortDate),
                        (l = (u = this.sha256).bind),
                        [4, this.getSigningKey(t, n, a, s)]
                      );
                    case 5:
                      return (
                        (c = new (l.apply(u, [void 0, f.sent()]))()).update(e),
                        (d = me),
                        [4, c.digest()]
                      );
                    case 6:
                  ...
                  switch (g.label) {
                    ...
                    case 4:
                      return (
                        ...
                        (d = l.longDate),
                        (f = l.shortDate),
                        (p = Ue(f, n, null != c ? c : this.service)),
                        (u.headers[Oe] = d),
                        t.sessionToken && (u.headers[Re] = t.sessionToken),
                        [4, Ve(u, this.sha256)]
                      );
                    case 5:
                      return (
                        ...
                        !(function (e, t) {
                          ...
                          try {
                            for (
                              var o = Ee(Object.keys(t)), i = o.next();
                              !i.done;
                              i = o.next()
                            )
                        ...
                        [
                          ...
                          this.getSignature(
                            d,
                            p,
                            this.getSigningKey(t, n, f, c),
                            this.createCanonicalRequest(u, v, h),
                          ),
                        ]
                      );
                    case 6:
            ...
            (e.prototype.createCanonicalRequest = function (e, t, n) {
              ...
              return (
                ...
                (function (e) {
                  ...
                  try {
                    for (
                      var c = Ee(Object.keys(o).sort()), u = c.next();
                      !u.done;
                      u = c.next()
                    )
                      a(u.value);
              ...
              return be(this, void 0, void 0, function () {
                ...
                return Se(this, function (u) {
                  switch (u.label) {
                    ...
                    case 1:
                      return (
                        (o = u.sent()), (a = (s = this.sha256).bind), [4, n]
                      );
                    case 2:
                      return (
                        (i = new (a.apply(s, [void 0, u.sent()]))()).update(o),
                        (c = me),
                        [4, i.digest()]
                      );
                    case 3:
      ...
      for (
        var et,
              ...
              return ut(t, void 0, void 0, function () {
                ...
                return lt(this, function (l) {
                  switch (l.label) {
                    case 0:
                      return (
                        (t = at(this.config.endpoint)),
                        (n = JSON.stringify(ht(e))),
                        (i = o.bind),
                        (c = {
                          method: dt,
                        }),
                    ...
                    case 1:
                      return (
                        (r = new (i.apply(o, [
                          void 0,
                          ((c.headers = ((u[s] = l.sent()), (u.host = t), u)),
                          (c.protocol = ct(this.config.endpoint)),
                          (c.hostname = t),
                          (c.path =
                            '/appmonitors/' + e.AppMonitorDetails.id + '/'),
                          (c.body = n),
                          c),
                        ]))()),
                        [4, this.awsSigV4.sign(r)]
                      );
                    case 2:
                      return (
                        (a = l.sent()),
                        [2, this.config.fetchRequestHandler.handle(a)]
                      );
                  }
                });
              });
                      ...
                      case 1:
                        return (
                          (r = new (i.apply(o, [
                            ...
                            (c.protocol = ct(this.config.endpoint)),
                            (c.hostname = t),
                            (c.path = '/appmonitors/' + e.AppMonitorDetails.id),
                            (c.body = n),
                            c),
                          ]))()),
                          [4, this.awsSigV4.presign(r, ft)]
                        );
                      case 2:
                        return (
                          (a = l.sent()),
                          [2, this.config.beaconRequestHandler.handle(a)]
                        );
                    }
                  });
                });
            ...
            return ut(void 0, void 0, void 0, function () {
              ...
              return lt(this, function (r) {
                switch (r.label) {
                  case 0:
                    return (
                      (t = new Qe.Sha256()).update(e), (n = me), [4, t.digest()]
                    );
                  case 1:
            ...
            return (
              ...
              (t.prototype.handle = function (t, n) {
                ...
                var p,
                  h = new Request(l, d),
                  v = [
                    this.fetchFunction.apply(window, [h]).then(function (t) {
                      for (
                        var n = t.headers, r = {}, o = 0, i = n.entries();
                        o < i.length;
                        o++
                      ) {
                        var s = i[o];
          ...
          St = 'CWR: Cannot dispatch; no AWS credentials.',
          Et = (function () {
            function e(e, t, n, r) {
              var o = this;
              (this.dispatchFetch = function () {
                ...
                (this.enabled = !0),
                (this.buildClient =
                  r.clientBuilder || this.defaultClientBuilder),
                (this.config = r),
                  ...
                  return bt(this, function (n) {
                    return this.enabled && this.eventCache.hasEvents()
                      ? ((t = {
                          BatchId: se(),
                          AppMonitorDetails:
                            this.eventCache.getAppMonitorDetails(),
          ...
          Tt = (function () {
            function e() {
              ...
              (this.eventListener = function () {
                0 === performance.getEntriesByType(Ct).length
                  ? e.performanceNavigationEventHandlerTimingLevel1()
                  : new PerformanceObserver(function (t) {
                      t.getEntries().forEach(function (t) {
                        t.entryType === Ct &&
                          e.performanceNavigationEventHandlerTimingLevel2(t);
                      });
                    }).observe({
                      entryTypes: [Ct],
                    });
                    ...
                    setTimeout(function () {
                      var t = performance.timing,
                        ...
                        r = {
                          ...
                          startTime: 0,
                          unloadEventStart:
                            t.unloadEventStart > 0 ? t.unloadEventStart - n : 0,
                          promptForUnload:
                            t.unloadEventEnd - t.unloadEventStart,
                          redirectStart:
                            t.redirectStart > 0 ? t.redirectStart - n : 0,
                          ...
                          connectStart:
                            t.connectStart > 0 ? t.connectStart - n : 0,
                          connect: t.connectEnd - t.connectStart,
                          secureConnectionStart:
                            t.secureConnectionStart > 0
                              ? t.secureConnectionStart - n
                              : 0,
                          tlsTime:
                            t.secureConnectionStart > 0
                              ...
                              : 0,
                          requestStart:
                            t.requestStart > 0 ? t.requestStart - n : 0,
                          timeToFirstByte: t.responseStart - t.requestStart,
                          responseStart:
                            t.responseStart > 0 ? t.responseStart - n : 0,
                          responseTime:
                            t.responseStart > 0
                              ? t.responseEnd - t.responseStart
                              : 0,
                          domInteractive:
                            t.domInteractive > 0 ? t.domInteractive - n : 0,
                          ...
                          domComplete:
                            t.domComplete > 0 ? t.domComplete - n : 0,
                          domProcessingTime: t.loadEventStart - t.responseEnd,
                          loadEventStart:
                            t.loadEventStart > 0 ? t.loadEventStart - n : 0,
                ...
                (this.performanceNavigationEventHandlerTimingLevel2 = function (
                  t,
                ) {
                  var n = {
                    version: '1.0.0',
                    ...
                    workerTime:
                      t.workerStart > 0 ? t.fetchStart - t.workerStart : 0,
                    ...
                    responseTime:
                      t.responseStart > 0 ? t.responseEnd - t.responseStart : 0,
                    ...
                    compressionRatio:
                      t.encodedBodySize > 0
                        ? t.decodedBodySize / t.encodedBodySize
                        : 0,
            ...
            return (
              (e.prototype.load = function (e) {
                if (((this.recordEvent = e.record), this.enabled))
                  ...
                  } else window.addEventListener(xt, this.eventListener);
              }),
              (e.prototype.enable = function () {
                this.enabled ||
                  ((this.enabled = !0),
              ...
              (e.prototype.disable = function () {
                this.enabled &&
                  ((this.enabled = !1),
                  this.eventListener &&
                    window.removeEventListener(xt, this.eventListener));
              }),
              (e.prototype.hasTheWindowLoadEventFired = function () {
                if (
                  window.performance &&
                  window.performance.getEntriesByType(Ct).length
                ) {
          ...
          Pt = (function () {
              ...
              (this.resourceEventListener = function (e) {
                var n = [],
                  ...
                  i = new PerformanceObserver(function (e) {
                    e.getEntries()
                      ...
                      .forEach(function (e) {
                        var o = st(e.name);
                        t.config.recordAllTypes.includes(o)
                          ? n.push(e)
                          : t.config.sampleTypes.includes(o) && r.push(e);
                      });
                  });
                i.observe({
                  entryTypes: [It],
                ...
                for (
                  void 0 !== s &&
                    ...
                    it(n);
                  n.length > 0 && o < t.config.eventLimit;

                )
                  t.recordResourceEvent(n.pop()), o++;
                for (it(r); r.length > 0 && o < t.config.eventLimit; )
                  t.recordResourceEvent(r.pop()), o++;
              }),
                (this.recordResourceEvent = function (e) {
                  if (
                    t.recordEvent &&
                    at(e.name) !== at(t.context.config.endpoint)
                  ) {
                    var n = {
                      version: '1.0.0',
                    ...
                    t.context.config.recordResourceUrl &&
                      (n.targetUrl = e.name),
                      t.recordEvent(
            ...
            return (
              ...
              (e.prototype.disable = function () {
                this.enabled &&
                  ((this.enabled = !1),
                  this.resourceEventListener &&
                    window.removeEventListener(_t, this.resourceEventListener));
              }),
              (e.prototype.getPluginId = function () {
                return this.pluginId;
              }),
          ...
          Ht = 'function' == typeof WeakSet ? new WeakSet() : new Set(),
          Dt = function (e, t, n) {
            var r;
            return function () {
              t.value >= 0 &&
                (n || Ht.has(t) || 'hidden' === document.visibilityState) &&
                ((t.delta = t.value - (r || 0)),
          ...
          Xt = (function () {
            ...
            return (
              ...
              (e.prototype.getWebVitalData = function (e, t) {
                var n = {
                  version: '1.0.0',
                  value: e.value,
                };
      ...
      var Qt,
        ...
        un = function (e) {
          return (
            (e.hostname ? e.hostname : e.url ? at(e.url) : at(e.toString())) ||
        ...
        vn = function (e) {
          for (var t = '', n = 0; n < e.length; n++) t += Yt[e[n]];
          return t;
        },
        yn =
          ((Qt = function (e, t) {
            ...
            return (
              ...
              (n.handleXhrLoadEvent = function (e) {
                ...
                if (r) {
                  ...
                  isNaN(i) ||
                    (r.trace.subsegments[0].http.response.content_length =
                      parseInt(t.getResponseHeader('Content-Length'), 10)),
                      ...
                      n &&
                        ...
                        e.isTracingEnabled() &&
                          ...
                          this.setRequestHeader(
                            nn,
                            ln(n.trace.trace_id, n.trace.subsegments[0].id),
                          )),
                      t.apply(this, arguments)
                    );
                  };
              ...
              (n.pluginId = 'com.amazonaws.rum.xhr'),
              (n.config = wn(wn({}, rn), t)),
              (n.xhrMap = new Map()),
              n
            );
        ...
        Cn = (function (e) {
          function t(t) {
            ...
            return (
              ...
              (n.beginTrace = function (e, t, r) {
                var o = sn(),
                  i = (function (e, t) {
                    ...
                    return (
                      (n.request.method = (null == e ? void 0 : e.method)
                        ? e.method
                        : 'GET'),
                      (n.request.traced = t),
                      n
                  ...
                  a = cn(un(e), o, i);
                return (
                  s.subsegments.push(a),
                  n.config.addXRayTraceIdHeader &&
                    n.addXRayTraceIdHeader(e, t, r, s),
                  s
                );
              }),
              (n.addXRayTraceIdHeader = function (e, t, n, r) {
                if (e.headers)
                  return (
                    (o = e.headers),
                    (i = r.trace_id),
                    (s = r.subsegments[0].id),
                    void o.set(nn, ln(i, s))
                  );
                var o, i, s;
                t || ((t = {}), [].push.call(n, t)),
                  (function (e, t, n) {
                    e.headers || (e.headers = {}), (e.headers[nn] = ln(t, n));
              ...
              (n.endTrace = function (e, t, r) {
                if (e) {
                  ...
                  if (((e.subsegments[0].end_time = o), (e.end_time = o), t)) {
                    ...
                    isNaN(i) ||
                      (e.subsegments[0].http.response.content_length = i);
                  }
                  r &&
                    ((e.subsegments[0].error = !0),
                    r instanceof Object
              ...
              (n.fetch = function (e, t, r, o, i) {
                ...
                return (
                  ...
                  on(a, n.config)
                    ? (n.isTracingEnabled() &&
                        n.isSessionRecorded() &&
                        (s = n.beginTrace(o, i, r)),
                      e
                        .apply(t, r)
                        .then(function (e) {
                          return (
                            n.endTrace(s, e, void 0),
                            n.recordHttpEventWithResponse(c, e),
                            e
                          );
                        })
                        .catch(function (e) {
                          throw (
                            (n.endTrace(s, void 0, e),
                            n.recordHttpEventWithError(c, e),
                            e)
                          );
                        }))
                    : e.apply(t, r)
              ...
              (n.pluginId = 'com.amazonaws.rum.fetch'),
              (n.config = En(En({}, rn), t)),
              n
            );
          }
        ...
        Tn = (function (e) {
          function t() {
            ...
            return (
              ...
              (t.pluginId = 'com.amazonaws.rum.page-view'),
              t.enable(),
              t
            );
          }
          return (
            xn(t, e),
            (t.prototype.load = function (e) {
              (this.context = e), this.addListener(), this.recordPageView();
            }),
            (t.prototype.getPluginId = function () {
              return this.pluginId;
            }),
      ...
      var _n = (function () {
          function e(e, t, n, r) {
            void 0 === r && (r = {}), void 0 === n && (n = 'us-west-2');
            var o = An(
              An(
                {},
                {
          ...
          return (
            ...
            (e.prototype.initDispatch = function (e) {
              ...
              return (
                this.config.identityPoolId && this.config.guestRoleArn
                  ? t.setAwsCredentials(
                      new P(this.config).ChainAnonymousCredentialsProvider,
                    )
                  : this.config.identityPoolId &&
                    t.setAwsCredentials(
                      new R(this.config).ChainAnonymousCredentialsProvider,
                    ),
                t
              );
            }),
            (e.prototype.initPluginManager = function (e, t) {
              var n = this.constructBuiltinPlugins(),
                ...
                i = new j(o);
              return (
                this.config.disableAutoPageView || i.addPlugin(new Tn()),
              ...
              return (
                this.config.telemetries.forEach(function (n) {
                  'string' == typeof n && t[n.toLowerCase()]
                    ? (e = In(In([], e, !0), t[n.toLowerCase()]({}), !0))
                    : Array.isArray(n) &&
                      t[n[0].toLowerCase()] &&
                      (e = In(In([], e, !0), t[n[0].toLowerCase()](n[1]), !0));
                }),
                e
              );
            }),
            (e.prototype.getDataPlaneEndpoint = function (e, t) {
              return t.endpoint
                ? t.endpoint
                : 'https://dataplane.rum.${REGION}.amazonaws.com'.replace(
                    '${REGION}',
                    e,
                  );
            }),
                              ...
                              switch (t.label) {
                                ...
                                case 3:
                                  throw (
                                    ((e = t.sent()),
                                    new Error(
                                      'CWR: Failed to load remote config: ' + e,
                                    ))
                                  );
                                case 4:
                                  return [2];
              ...
              return Rn(this, void 0, void 0, function () {
                ...
                return jn(this, function (n) {
                  if (!(t = this.commandHandlerMap[e.c]))
                    throw new Error(
                      'CWR: UnsupportedOperationException: ' + e.c,
                    );
                  return t(e.p), [2];
                });
              });
      ...
      !window.AwsRumClient &&
        ...
        'function' == typeof fetch && 'function' == typeof navigator.sendBeacon
          ? new Hn().init(window.AwsRumClient)
